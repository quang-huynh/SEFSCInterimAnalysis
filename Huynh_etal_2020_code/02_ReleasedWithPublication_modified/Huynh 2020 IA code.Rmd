...
MPNamesSub <- c("SCA_10","SCA_1","iMP_10","buffer_iMP_10")
...
OMNames <- c("capelin","vs","POP")
scenNames <- c("base","hs","hd","dep","lf","epiM")
MPNamesSub <- c("SCA_1","iMP_10","buffer_iMP_10","SCA_10", "pMP_10",
                        "iMP_5", "buffer_iMP_5", "SCA_5",  "pMP_5")
...
MPNamesSub <- c("iMP_10","buffer_iMP_10","pMP_10")
