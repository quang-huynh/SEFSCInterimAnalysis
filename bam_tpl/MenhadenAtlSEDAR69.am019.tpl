...
PARAMETER_SECTION
 ...
 LOCAL_CALCS
  ...
  const double log_dm_cRn_ac_LO=set_log_dm_cRn_ac(2); const double log_dm_cRn_ac_HI=set_log_dm_cRn_ac(3); const double log_dm_cRn_ac_PH=set_log_dm_cRn_ac(4);
  const double log_dm_cRs_ac_LO=set_log_dm_cRs_ac(2); const double log_dm_cRs_ac_HI=set_log_dm_cRs_ac(3); const double log_dm_cRs_ac_PH=set_log_dm_cRs_ac(4);
  const double log_dm_cBn_ac_LO=set_log_dm_cBn_ac(2); const double log_dm_cBn_ac_HI=set_log_dm_cBn_ac(3); const double log_dm_cBn_ac_PH=set_log_dm_cBn_ac(4);
  const double log_dm_cBs_ac_LO=set_log_dm_cBs_ac(2); const double log_dm_cBs_ac_HI=set_log_dm_cBs_ac(3); const double log_dm_cBs_ac_PH=set_log_dm_cBs_ac(4);

  const double log_dm_nad_lc_LO=set_log_dm_nad_lc(2); const double log_dm_nad_lc_HI=set_log_dm_nad_lc(3); const double log_dm_nad_lc_PH=set_log_dm_nad_lc(4);
  const double log_dm_mad_lc_LO=set_log_dm_mad_lc(2); const double log_dm_mad_lc_HI=set_log_dm_mad_lc(3); const double log_dm_mad_lc_PH=set_log_dm_mad_lc(4);
  ...
  const double log_q_nad_LO=set_log_q_nad(2); const double log_q_nad_HI=set_log_q_nad(3); const double log_q_nad_PH=set_log_q_nad(4);
  const double log_q_mad_LO=set_log_q_mad(2); const double log_q_mad_HI=set_log_q_mad(3); const double log_q_mad_PH=set_log_q_mad(4);
  const double log_q_sad_LO=set_log_q_sad(2); const double log_q_sad_HI=set_log_q_sad(3); const double log_q_sad_PH=set_log_q_sad(4);
  const double log_q_jai_LO=set_log_q_jai(2); const double log_q_jai_HI=set_log_q_jai(3); const double log_q_jai_PH=set_log_q_jai(4);
  ...
  const double log_q_mar_LO=set_log_q_mar(2); const double log_q_mar_HI=set_log_q_mar(3); const double log_q_mar_PH=set_log_q_mar(4);
  const double log_q_eco_LO=set_log_q_eco(2); const double log_q_eco_HI=set_log_q_eco(3); const double log_q_eco_PH=set_log_q_eco(4);
...
//---Catchability (CPUE q's)----------------------------------------------------------
  ...
  number q_rate;
  vector q_rate_fcn_nad(styr_nad_cpue,endyr_nad_cpue);    //increase due to technology creep (saturates in 2003)-shouldn't really be used since fishery-independent 
  vector q_rate_fcn_mad(styr_mad_cpue,endyr_mad_cpue);    //increase due to technology creep (saturates in 2003)-shouldn't really be used since fishery-independent 
  vector q_rate_fcn_sad(styr_sad_cpue,endyr_sad_cpue);    //increase due to technology creep (saturates in 2003)-shouldn't really be used since fishery-independent 
  vector q_rate_fcn_jai(styr_jai_cpue,endyr_jai_cpue);    //increase due to technology creep (saturates in 2003)-shouldn't really be used since fishery-independent
  ...
  init_bounded_vector q_RW_log_dev_nad(styr_nad_cpue,endyr_nad_cpue-1,log_RWq_LO,log_RWq_HI,log_RWq_PH);
  init_bounded_vector q_RW_log_dev_mad(styr_mad_cpue,endyr_mad_cpue-1,log_RWq_LO,log_RWq_HI,log_RWq_PH);
  init_bounded_vector q_RW_log_dev_sad(styr_sad_cpue,endyr_sad_cpue-1,log_RWq_LO,log_RWq_HI,log_RWq_PH);
  init_bounded_vector q_RW_log_dev_jai(styr_jai_cpue,endyr_jai_cpue-1,log_RWq_LO,log_RWq_HI,log_RWq_PH); 
...
////--------Mortality------------------------------------------------------------------
  ...
  init_bounded_dev_vector log_F_dev_cRn(styr_cRn_L,endyr_cRn_L,log_F_dev_cRn_LO,log_F_dev_cRn_HI,log_F_dev_cRn_PH);
  ...
  init_bounded_dev_vector log_F_dev_cRs(styr_cRs_L,endyr_cRs_L,log_F_dev_cRs_LO,log_F_dev_cRs_HI,log_F_dev_cRs_PH);
  ...
  init_bounded_dev_vector log_F_dev_cBn(styr_cBn_L,endyr_cBn_L,log_F_dev_cBn_LO,log_F_dev_cBn_HI,log_F_dev_cBn_PH);
  ...
  init_bounded_dev_vector log_F_dev_cBs(styr_cBs_L,endyr_cBs_L,log_F_dev_cBs_LO,log_F_dev_cBs_HI,log_F_dev_cBs_PH);
...
//---Length comps-------------------------------
  ...
  //f_nad_lenc
  //f_nad_lenc=lk_robust_multinomial(nsamp_nad_lenc, pred_nad_lenc, obs_nad_lenc, nyr_nad_lenc, double(nlenbins), minSS_nad_lenc, w_lc_nad);
  //f_nad_lenc=lk_logistic_normal(nsamp_nad_lenc, pred_nad_lenc, obs_nad_lenc, nyr_nad_lenc, double(nlenbins), minSS_nad_lenc);
  f_nad_lenc=lk_dirichlet_multinomial(nsamp_nad_lenc, pred_nad_lenc, obs_nad_lenc, nyr_nad_lenc, double(nlenbins), minSS_nad_lenc, log_dm_nad_lc);
  fval+=f_nad_lenc;
  fval_data+=f_nad_lenc;
  
  //f_mad_lenc
  //f_mad_lenc=lk_robust_multinomial(nsamp_mad_lenc, pred_mad_lenc, obs_mad_lenc, nyr_mad_lenc, double(nlenbins), minSS_mad_lenc, w_lc_mad);
  //f_mad_lenc=lk_logistic_normal(nsamp_mad_lenc, pred_mad_lenc, obs_mad_lenc, nyr_mad_lenc, double(nlenbins), minSS_mad_lenc);
  f_mad_lenc=lk_dirichlet_multinomial(nsamp_mad_lenc, pred_mad_lenc, obs_mad_lenc, nyr_mad_lenc, double(nlenbins), minSS_mad_lenc, log_dm_mad_lc);
  fval+=f_mad_lenc;
...
//---Age comps-------------------------------
  ...
  //f_cRn_agec
  //f_cRn_agec=lk_robust_multinomial(nsamp_cRn_agec, pred_cRn_agec, obs_cRn_agec, nyr_cRn_agec, double(nages_agec), minSS_cRn_agec, w_ac_cRn);
  //f_cRn_agec=lk_logistic_normal(nsamp_cRn_agec, pred_cRn_agec, obs_cRn_agec, nyr_cRn_agec, double(nages_agec), minSS_cRn_agec);
  f_cRn_agec=lk_dirichlet_multinomial(nsamp_cRn_agec, pred_cRn_agec, obs_cRn_agec, nyr_cRn_agec, double(nages_agec), minSS_cRn_agec, log_dm_cRn_ac);
  fval+=f_cRn_agec;
  fval_data+=f_cRn_agec;

  //f_cRs_agec
  //f_cRs_agec=lk_robust_multinomial(nsamp_cRs_agec, pred_cRs_agec, obs_cRs_agec, nyr_cRs_agec, double(nages_agec), minSS_cRs_agec, w_ac_cRs);
  //f_cRs_agec=lk_logistic_normal(nsamp_cRs_agec, pred_cRs_agec, obs_cRs_agec, nyr_cRs_agec, double(nages_agec), minSS_cRs_agec);
  f_cRs_agec=lk_dirichlet_multinomial(nsamp_cRs_agec, pred_cRs_agec, obs_cRs_agec, nyr_cRs_agec, double(nages_agec), minSS_cRs_agec, log_dm_cRs_ac);
  fval+=f_cRs_agec;
  fval_data+=f_cRs_agec;

  //f_cBn_agec
  //f_cBn_agec=lk_robust_multinomial(nsamp_cBn_agec, pred_cBn_agec, obs_cBn_agec, nyr_cBn_agec, double(nages_agec), minSS_cBn_agec, w_ac_cBn);
  //f_cBn_agec=lk_logistic_normal(nsamp_cBn_agec, pred_cBn_agec, obs_cBn_agec, nyr_cBn_agec, double(nages_agec), minSS_cBn_agec);
  f_cBn_agec=lk_dirichlet_multinomial(nsamp_cBn_agec, pred_cBn_agec, obs_cBn_agec, nyr_cBn_agec, double(nages_agec), minSS_cBn_agec, log_dm_cBn_ac);
  fval+=f_cBn_agec;
  fval_data+=f_cBn_agec;

  //f_cBs_agec
  //f_cBs_agec=lk_robust_multinomial(nsamp_cBs_agec, pred_cBs_agec, obs_cBs_agec, nyr_cBs_agec, double(nages_agec), minSS_cBs_agec, w_ac_cBs);
  //f_cBs_agec=lk_logistic_normal(nsamp_cBs_agec, pred_cBs_agec, obs_cBs_agec, nyr_cBs_agec, double(nages_agec), minSS_cBs_agec);
  f_cBs_agec=lk_dirichlet_multinomial(nsamp_cBs_agec, pred_cBs_agec, obs_cBs_agec, nyr_cBs_agec, double(nages_agec), minSS_cBs_agec, log_dm_cBs_ac);
  fval+=f_cBs_agec;
...
REPORT_SECTION
  ...
  if (last_phase())  
  {
      ...
      sdnr_lc_nad=sdnr_multinomial(nyr_nad_lenc, lenbins, nsamp_nad_lenc, pred_nad_lenc, obs_nad_lenc, w_lc_nad);
      sdnr_lc_mad=sdnr_multinomial(nyr_mad_lenc, lenbins, nsamp_mad_lenc, pred_mad_lenc, obs_mad_lenc, w_lc_mad);
      //sdnr_lc_sad=sdnr_multinomial(nyr_sad_lenc, lenbins, nsamp_sad_lenc, pred_sad_lenc, obs_sad_lenc, w_lc_sad);

      sdnr_ac_cRn=sdnr_multinomial(nyr_cRn_agec, agebins_agec, nsamp_cRn_agec, pred_cRn_agec, obs_cRn_agec, w_ac_cRn);
      sdnr_ac_cRs=sdnr_multinomial(nyr_cRs_agec, agebins_agec, nsamp_cRs_agec, pred_cRs_agec, obs_cRs_agec, w_ac_cRs);
      sdnr_ac_cBn=sdnr_multinomial(nyr_cBn_agec, agebins_agec, nsamp_cBn_agec, pred_cBn_agec, obs_cBn_agec, w_ac_cBn);
      sdnr_ac_cBs=sdnr_multinomial(nyr_cBs_agec, agebins_agec, nsamp_cBs_agec, pred_cBs_agec, obs_cBs_agec, w_ac_cBs); 
