...
init_vector cv_L_cHl(styr_L_cHl,endyr_L_cHl);

// L_cTw
init_int styr_L_cTw; 
init_int endyr_L_cTw;
init_vector obs_L_cTw(styr_L_cTw,endyr_L_cTw);
init_vector cv_L_cTw(styr_L_cTw,endyr_L_cTw);

// L_rHb
init_int styr_L_rHb;
init_int endyr_L_rHb;
init_vector obs_L_rHb(styr_L_rHb,endyr_L_rHb);
init_vector cv_L_rHb(styr_L_rHb,endyr_L_rHb);

// L_rGe
init_int styr_L_rGe;
init_int endyr_L_rGe;
init_vector obs_L_rGe(styr_L_rGe,endyr_L_rGe); 
init_vector cv_L_rGe(styr_L_rGe,endyr_L_rGe);
...
init_vector cv_released_cHl(styr_D_cHl,endyr_D_cHl);

// D_rHb
init_int styr_D_rHb;
init_int endyr_D_rHb;
init_vector obs_released_rHb(styr_D_rHb,endyr_D_rHb);
init_vector cv_released_rHb(styr_D_rHb,endyr_D_rHb);

// D_rGe
init_int styr_D_rGe;
init_int endyr_D_rGe;
init_vector obs_released_rGe(styr_D_rGe,endyr_D_rGe);
init_vector cv_released_rGe(styr_D_rGe,endyr_D_rGe);
...
init_vector cv_cpue_sCT(styr_cpue_sCT,endyr_cpue_sCT);
...
init_vector cv_cpue_rHb(styr_cpue_rHb,endyr_cpue_rHb);
...
// lenc_cTw
init_int nyr_lenc_cTw_pool;
init_ivector yrs_lenc_cTw_pool(1,nyr_lenc_cTw_pool);
init_vector nsamp_lenc_cTw_pool(1,nyr_lenc_cTw_pool);
init_vector nfish_lenc_cTw_pool(1,nyr_lenc_cTw_pool);
//
...
init_vector set_log_avg_F_L_rGe(1,7);
init_vector set_log_avg_F_D_cHl(1,7);
init_vector set_log_avg_F_D_rHb(1,7);
init_vector set_log_avg_F_D_rGe(1,7);

////// Dev Vector //////
////Parameter values (vals) and bounds (upper, lower, phase) //
// F
init_vector set_log_F_dev_L_cHl(1,3); 
init_vector set_log_F_dev_L_cTw(1,3); 
init_vector set_log_F_dev_L_rHb(1,3);
init_vector set_log_F_dev_L_rGe(1,3);
init_vector set_log_F_dev_D_cHl(1,3); 
init_vector set_log_F_dev_D_rHb(1,3);
init_vector set_log_F_dev_D_rGe(1,3);
// Random walk on q
...
// F
init_vector set_log_F_dev_L_cHl_vals(styr_L_cHl,endyr_L_cHl);
init_vector set_log_F_dev_L_cTw_vals(styr_L_cTw,endyr_L_cTw);
init_vector set_log_F_dev_L_rHb_vals(styr_L_rHb,endyr_L_rHb);
init_vector set_log_F_dev_L_rGe_vals(styr_L_rGe,endyr_L_rGe);
init_vector set_log_F_dev_D_cHl_vals(styr_D_cHl,endyr_D_cHl);
init_vector set_log_F_dev_D_rHb_vals(styr_D_rHb,endyr_D_rHb);
init_vector set_log_F_dev_D_rGe_vals(styr_D_rGe,endyr_D_rGe);
// Recruitment devs
...
init_matrix maturity_f_obs(styr,endyr,1,nages);            // proportion females mature at age
init_vector maturity_m_obs(1,nages);            // proportion males mature at age
init_vector prop_f_obs(1,nages);                // proportion female by age
...
////--------------Growth--------------------------------------------------------------------------- 
  ...
  matrix len_rGe_mm(styr,endyr,1,nages);          //mean length at age of L_rGe in mm     
  matrix wholewgt_rGe_klb(styr,endyr,1,nages);    //whole wgt of L_rGe in 1000 lb    
  ...
  matrix len_D_rGe_mm(styr,endyr,1,nages);          //mean length at age of D_rGe in mm     
  matrix wholewgt_D_rGe_klb(styr,endyr,1,nages);    //whole wgt of D_rGe in 1000 lb  
...
//----Predicted length and age compositions
  ...
  matrix pred_lenc_cTw_yr(1,nyr_lenc_cTw_pool,1,nlenbins);
...
// sel_rGe 
  matrix sel_rGe(styr,endyr,1,nages);
  vector sel_rGe_block1(1,nages);
  vector sel_rGe_block2(1,nages);
  vector sel_rGe_block3(1,nages);

  
// sel_D
  matrix sel_D_cHl(styr,endyr,1,nages);
  matrix sel_D_rHb(styr,endyr,1,nages);
  matrix sel_D_rGe(styr,endyr,1,nages);
...
//---Landings in numbers (total or 1000 fish) and in wgt (whole klb)--------------------------------------------------
  ...
  matrix L_rGe_num(styr,endyr,1,nages);   //landings (numbers) at age
  matrix L_rGe_klb(styr,endyr,1,nages);   //landings (1000 lb whole weight) at age
  vector pred_L_rGe_knum(styr,endyr);     //yearly landings in 1000 fish summed over ages
  vector pred_L_rGe_klb(styr,endyr);      //yearly landings in 1000 lb whole summed over ages
...
//---Discards (number dead fish) --------------------------------------------------
  ...
  matrix D_rGe_num(styr,endyr,1,nages);             //discards (numbers) at age
  matrix D_rGe_klb(styr,endyr,1,nages);             //discards (1000 lb) at age
  //vector pred_D_rGe_knum(styr_D_rGe,endyr_D_rGe);     //yearly dead discards summed over ages
  vector obs_D_rGe(styr_D_rGe,endyr_D_rGe);           //observed releases multiplied by discard mortality
  //vector pred_D_rGe_klb(styr_D_rGe,endyr_D_rGe);      //yearly dead discards in klb whole wgt summed over ages
  vector pred_D_rGe_knum(styr,endyr);     //yearly dead discards summed over ages
  vector pred_D_rGe_klb(styr,endyr);      //yearly dead discards in klb whole wgt summed over ages
...
////---MSY calcs----------------------------------------------------------------------------
  ...
  number F_prop_L_rGe;       //proportion of F_sum attributable to rGe, last X=selpar_n_yrs_wgted yrs
  ...
  number F_prop_D_rGe;     //proportion of F_sum attributable to D_rGe, last X=selpar_n_yrs_wgted yrs
...
////--------Mortality------------------------------------------------------------------
  ...
  init_bounded_dev_vector log_F_dev_L_cHl(styr_L_cHl,endyr_L_cHl,log_F_dev_L_cHl_LO,log_F_dev_L_cHl_HI,log_F_dev_L_cHl_PH); //LINETAG: L_cHl
  ...
  init_bounded_dev_vector log_F_dev_L_cTw(styr_L_cTw,endyr_L_cTw,log_F_dev_L_cTw_LO,log_F_dev_L_cTw_HI,log_F_dev_L_cTw_PH); //LINETAG: L_cTw
  ...
  init_bounded_dev_vector log_F_dev_L_rHb(styr_L_rHb,endyr_L_rHb,log_F_dev_L_rHb_LO,log_F_dev_L_rHb_HI,log_F_dev_L_rHb_PH); //LINETAG: L_rHb    
  ...
  init_bounded_number log_avg_F_L_rGe(log_avg_F_L_rGe_LO,log_avg_F_L_rGe_HI,log_avg_F_L_rGe_PH); //LINETAG: L_rGe
  vector log_avg_F_L_rGe_out(1,8);  //LINETAG: L_rGe
  init_bounded_dev_vector log_F_dev_L_rGe(styr_L_rGe,endyr_L_rGe,log_F_dev_L_rGe_LO,log_F_dev_L_rGe_HI,log_F_dev_L_rGe_PH);     //LINETAG: L_rGe
  vector log_F_dev_L_rGe_out(styr_L_rGe,endyr_L_rGe); //LINETAG: L_rGe
  matrix F_rGe(styr,endyr,1,nages); //LINETAG: L_rGe
  vector F_rGe_out(styr,endyr); //used for intermediate calculations in fcn get_mortality //LINETAG: L_rGe
  number log_F_dev_init_L_rGe;     //LINETAG: L_rGe
  number log_F_dev_end_L_rGe;   //LINETAG: L_rGe
  ...
  init_bounded_dev_vector log_F_dev_D_cHl(styr_D_cHl,endyr_D_cHl,log_F_dev_D_cHl_LO,log_F_dev_D_cHl_HI,log_F_dev_D_cHl_PH); //LINETAG: D_cHl
  ...
  init_bounded_dev_vector log_F_dev_D_rHb(styr_D_rHb,endyr_D_rHb,log_F_dev_D_rHb_LO,log_F_dev_D_rHb_HI,log_F_dev_D_rHb_PH); //LINETAG: D_rHb
  ...
  init_bounded_number log_avg_F_D_rGe(log_avg_F_D_rGe_LO,log_avg_F_D_rGe_HI,log_avg_F_D_rGe_PH); //LINETAG: D_rGe
  vector log_avg_F_D_rGe_out(1,8);   //LINETAG: D_rGe
  init_bounded_dev_vector log_F_dev_D_rGe(styr_D_rGe,endyr_D_rGe,log_F_dev_D_rGe_LO,log_F_dev_D_rGe_HI,log_F_dev_D_rGe_PH); //LINETAG: D_rGe
  vector log_F_dev_D_rGe_out(styr_D_rGe,endyr_D_rGe); //LINETAG: D_rGe
  matrix F_D_rGe(styr,endyr,1,nages); //LINETAG: D_rGe
  vector F_D_rGe_out(styr,endyr);        //used for intermediate calculations in fcn get_mortality //LINETAG: D_rGe
  number log_F_dev_end_D_rGe;  //LINETAG: D_rGe
  number log_F_avgdev_D_rGe; //LINETAG: D_rGe
  ...
  //number F_init_rGe_prop;  //proportion of F_init attributable to rGe, first X yrs
