//##--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>
//##
//##  SEDAR 36 Update  Snowy Grouper assessment model, Summer 2020
//##  NMFS, Beaufort Lab, Sustainable Fisheries Branch
//##
//## last modified 8/31/2020 by r. cheshire to adapt to snowy grouper 2020 update
//##--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>--><>
DATA_SECTION
...
//###################MARMAP vertical longline ##########################################
//CPUE: MMvll
init_int styr_vll_cpue;                                             
init_int endyr_vll_cpue;                                            
init_vector obs_vll_cpue(styr_vll_cpue,endyr_vll_cpue);//Observed CPUE
init_vector vll_cpue_cv(styr_vll_cpue,endyr_vll_cpue); //CV of cpue
// MMvll Age Compositions
init_int nyr_vll_agec;
init_ivector yrs_vll_agec(1,nyr_vll_agec);
init_vector nsamp_vll_agec(1,nyr_vll_agec);
init_vector nfish_vll_agec(1,nyr_vll_agec);
init_matrix obs_vll_agec(1,nyr_vll_agec,1,nages_agec);
...
// Comm Longline  Landings (1000 lb whole weight)
init_int styr_cL_L;
init_int endyr_cL_L;
init_vector obs_cL_L(styr_cL_L,endyr_cL_L);
init_vector cL_L_cv(styr_cL_L,endyr_cL_L);
...
// Comm cL age compositions
// Uncomment for pooled age comps##						  
//init_int nyr_cL_agec_pool;
//init_ivector yrs_cL_agec_pool(1,nyr_cL_agec_pool);
//# Annual sample size (nfish) of age comp data; used to weight years for pooling
//init_vector nfish_cL_agec_pool(1,nyr_cL_agec_pool);
//## cL ## Number and vector of years of age compositions, after pooling												  
init_int nyr_cL_agec;
init_ivector yrs_cL_agec(1,nyr_cL_agec);
//## cL ## Sample size of age comp data (first row observed n.trips, second row n.fish)																					   
init_vector nsamp_cL_agec(1,nyr_cL_agec);
init_vector nfish_cL_agec(1,nyr_cL_agec);
//## cL ## Observed age comps (proportions by year)												   
init_matrix obs_cL_agec(1,nyr_cL_agec,1,nages_agec);
!!cout << " nfish_cL_agec" << endl;
!!cout<<  nfish_cL_agec << endl;
...
init_vector set_log_dm_vll_ac(1,7);   //Dirichlet-multinomial overdispersion parameter
...
init_vector set_selpar_A50_cL1(1,7);
init_vector set_selpar_slope_cL1(1,7);
// init_vector set_selpar_A50_cL2(1,7);
// init_vector set_selpar_A50_cL3(1,7);
// init_vector set_selpar_slope_cL2(1,7);
// init_vector set_selpar_A502_cL2(1,7); 
// init_vector set_selpar_slope2_cL2(1,7);
...
init_vector set_selpar_A50_GR1(1,7);
init_vector set_selpar_slope_GR1(1,7);
init_vector set_selpar_afull_GR1(1,7);
init_vector set_selpar_sigma_GR1(1,7);
init_vector set_selpar_A50_GR2(1,7);
init_vector set_selpar_slope_GR2(1,7);
init_vector set_selpar_afull_GR2(1,7);
init_vector set_selpar_sigma_GR2(1,7);
init_vector set_selpar_A50_GR3(1,7);
init_vector set_selpar_slope_GR3(1,7);
init_vector set_selpar_afull_GR3(1,7);
init_vector set_selpar_sigma_GR3(1,7);
// init_vector set_selpar_A50_GR1(1,7);
// init_vector set_selpar_slope_GR1(1,7);
// init_vector set_selpar_A50_GR2(1,7);
// init_vector set_selpar_slope_GR2(1,7);
...
init_vector set_selpar_afull_CVT(1,7);
init_vector set_selpar_sigma_CVT(1,7);
// init_vector set_selpar_A50_CVT(1,7); 
// init_vector set_selpar_slope_CVT(1,7);
// init_vector set_selpar_A502_CVT(1,7); 
// init_vector set_selpar_slope2_CVT(1,7);

init_vector set_selpar_A50_vll(1,7); 
init_vector set_selpar_slope_vll(1,7);
...
init_vector set_log_q_CVT(1,7);     //catchability coefficient (log) for FI trap index  
init_vector set_log_q_vll(1,7);     //catchability coefficient (log) for FI vll index  
...
init_number set_w_I_vll;        //weight for vll index

init_number set_w_lc_cH;        //weight for comm handline len comps
init_number set_w_lc_cL;        //weight for comm longline len comps
...
init_number set_w_ac_cL;        //weight for comm longline age comps
//init_number set_w_ac_HB;        //weight for headboat age comps
init_number set_w_ac_GR;		//weight for the Recreational age comps  
init_number set_w_ac_CVT;		//weight for the FI trap age comps 
init_number set_w_ac_vll;		//weight for the FI vll age comps 
...
PARAMETER_SECTION
 ...
 LOCAL_CALCS
  ...
  const double log_dm_vll_ac_LO=set_log_dm_vll_ac(2); const double log_dm_vll_ac_HI=set_log_dm_vll_ac(3); const double log_dm_vll_ac_PH=set_log_dm_vll_ac(4);
  ...
  const double selpar_A50_cL1_LO=set_selpar_A50_cL1(2); const double selpar_A50_cL1_HI=set_selpar_A50_cL1(3); const double selpar_A50_cL1_PH=set_selpar_A50_cL1(4);
  const double selpar_slope_cL1_LO=set_selpar_slope_cL1(2); const double selpar_slope_cL1_HI=set_selpar_slope_cL1(3); const double selpar_slope_cL1_PH=set_selpar_slope_cL1(4);
  ...
  // const double selpar_A502_cL2_LO=set_selpar_A502_cL2(2); const double selpar_A502_cL2_HI=set_selpar_A502_cL2(3); const double selpar_A502_cL2_PH=set_selpar_A502_cL2(4);
  // const double selpar_slope2_cL2_LO=set_selpar_slope2_cL2(2); const double selpar_slope2_cL2_HI=set_selpar_slope2_cL2(3); const double selpar_slope2_cL2_PH=set_selpar_slope2_cL2(4);
  ...
  const double selpar_afull_GR1_LO=set_selpar_afull_GR1(2); const double selpar_afull_GR1_HI=set_selpar_afull_GR1(3); const double selpar_afull_GR1_PH=set_selpar_afull_GR1(4);
  const double selpar_sigma_GR1_LO=set_selpar_sigma_GR1(2); const double selpar_sigma_GR1_HI=set_selpar_sigma_GR1(3); const double selpar_sigma_GR1_PH=set_selpar_sigma_GR1(4);
  ...
  const double selpar_afull_GR2_LO=set_selpar_afull_GR2(2); const double selpar_afull_GR2_HI=set_selpar_afull_GR2(3); const double selpar_afull_GR2_PH=set_selpar_afull_GR2(4);
  const double selpar_sigma_GR2_LO=set_selpar_sigma_GR2(2); const double selpar_sigma_GR2_HI=set_selpar_sigma_GR2(3); const double selpar_sigma_GR2_PH=set_selpar_sigma_GR2(4);
  ...
  const double selpar_afull_GR3_LO=set_selpar_afull_GR3(2); const double selpar_afull_GR3_HI=set_selpar_afull_GR3(3); const double selpar_afull_GR3_PH=set_selpar_afull_GR3(4);
  const double selpar_sigma_GR3_LO=set_selpar_sigma_GR3(2); const double selpar_sigma_GR3_HI=set_selpar_sigma_GR3(3); const double selpar_sigma_GR3_PH=set_selpar_sigma_GR3(4);
  ...
  const double selpar_A50_vll_LO=set_selpar_A50_vll(2); const double selpar_A50_vll_HI=set_selpar_A50_vll(3); const double selpar_A50_vll_PH=set_selpar_A50_vll(4);
  const double selpar_slope_vll_LO=set_selpar_slope_vll(2); const double selpar_slope_vll_HI=set_selpar_slope_vll(3); const double selpar_slope_vll_PH=set_selpar_slope_vll(4);
  ...
  const double log_q_vll_LO=set_log_q_vll(2); const double log_q_vll_HI=set_log_q_vll(3); const double log_q_vll_PH=set_log_q_vll(4);
...
////--------------Growth--------------------------------------------------------------------------- 
  ...
  matrix lenprob_vll(1,nages,1,nlenbins);    //distn of size at age in vll
...
//----Predicted length and age compositions
  ...
  //uncomment 2 lines below for pooled comps
//matrix pred_cL_agec_allages_yr(1,nyr_cL_agec_pool,1,nages);		//matrix ErrorFree_cL_agec_yr(1,nyr_cL_agec_pool,1,nages);														
...
//vector neff_HB_agec_allyr(styr,endyr);
  ...
  vector neff_vll_agec_allyr(styr,endyr);
...
//---Stock-Recruit Function (Beverton-Holt, steepness parameterization)----------
  ...
  init_bounded_number log_dm_vll_ac(log_dm_vll_ac_LO,log_dm_vll_ac_HI,log_dm_vll_ac_PH);
...
//Commercial handline-------------------------------------------------
  ...
  vector sel_cL_block1(1,nages);
  vector sel_cL_block2(1,nages);
  vector sel_cL_block3(1,nages);
  vector sel_cL_vec(1,nages);

  init_bounded_number selpar_A50_cL1(selpar_A50_cL1_LO,selpar_A50_cL1_HI,selpar_A50_cL1_PH);
  init_bounded_number selpar_slope_cL1(selpar_slope_cL1_LO,selpar_slope_cL1_HI,selpar_slope_cL1_PH);
  ...
  // init_bounded_number selpar_A502_cL2(selpar_A502_cL2_LO,selpar_A502_cL2_HI,selpar_A502_cL2_PH);
  // init_bounded_number selpar_slope2_cL2(selpar_slope2_cL2_LO,selpar_slope2_cL2_HI,selpar_slope2_cL2_PH);
  
  vector selpar_A50_cL1_out(1,8);
  vector selpar_slope_cL1_out(1,8);
  // vector selpar_A50_cL2_out(1,8);
  // vector selpar_A50_cL3_out(1,8);
  // vector selpar_slope_cL2_out(1,8);
  // vector selpar_A502_cL2_out(1,8);
  // vector selpar_slope2_cL2_out(1,8);
  ...
  init_bounded_number selpar_afull_GR1(selpar_afull_GR1_LO,selpar_afull_GR1_HI,selpar_afull_GR1_PH);
  init_bounded_number selpar_sigma_GR1(selpar_sigma_GR1_LO,selpar_sigma_GR1_HI,selpar_sigma_GR1_PH);
  ...
  init_bounded_number selpar_afull_GR2(selpar_afull_GR2_LO,selpar_afull_GR2_HI,selpar_afull_GR2_PH);
  init_bounded_number selpar_sigma_GR2(selpar_sigma_GR2_LO,selpar_sigma_GR2_HI,selpar_sigma_GR2_PH); 
  ...
  init_bounded_number selpar_afull_GR3(selpar_afull_GR3_LO,selpar_afull_GR3_HI,selpar_afull_GR3_PH);
  init_bounded_number selpar_sigma_GR3(selpar_sigma_GR3_LO,selpar_sigma_GR3_HI,selpar_sigma_GR3_PH); 
  // init_bounded_number selpar_A50_GR1(selpar_A50_GR1_LO,selpar_A50_GR1_HI,selpar_A50_GR1_PH);
  // init_bounded_number selpar_slope_GR1(selpar_slope_GR1_LO,selpar_slope_GR1_HI,selpar_slope_GR1_PH);
  // init_bounded_number selpar_A50_GR2(selpar_A50_GR2_LO,selpar_A50_GR2_HI,selpar_A50_GR2_PH);
  // init_bounded_number selpar_slope_GR2(selpar_slope_GR2_LO,selpar_slope_GR2_HI,selpar_slope_GR2_PH);    
  ...
  vector selpar_afull_GR1_out(1,8);
  vector selpar_sigma_GR1_out(1,8);
  vector selpar_A50_GR2_out(1,8);
  vector selpar_slope_GR2_out(1,8);
  vector selpar_afull_GR2_out(1,8);
  vector selpar_sigma_GR2_out(1,8); 
  vector selpar_A50_GR3_out(1,8);
  vector selpar_slope_GR3_out(1,8);
  vector selpar_afull_GR3_out(1,8);
  vector selpar_sigma_GR3_out(1,8);
...
//MARMAP chevron trap index selectivity  
  ...
  //MARMAP vll index selectivity  
  matrix sel_vll(styr,endyr,1,nages);
  vector sel_vll_vec(1,nages);
  
  init_bounded_number selpar_A50_vll(selpar_A50_vll_LO,selpar_A50_vll_HI,selpar_A50_vll_PH);
  init_bounded_number selpar_slope_vll(selpar_slope_vll_LO,selpar_slope_vll_HI,selpar_slope_vll_PH);

  vector selpar_A50_vll_out(1,8);
...
//Fishery dependent random walk catchability
 ...
 vector q_RW_log_dev_vll(styr_vll_cpue,endyr_vll_cpue-1); 
...
//Fishery dependent catchability over time, may be constant
 ...
 vector q_CVT(styr_CVT_cpue,endyr_CVT_cpue); 
  vector q_vll(styr_vll_cpue,endyr_vll_cpue); 
...
////---MSY calcs----------------------------------------------------------------------------
  ...
  number F_cL_prop;       //proportion of F_sum attributable to cH, last X=selpar_n_yrs_wgted yrs  
  ...
  number F_init_GR_prop;  //proportion of F_init attributable to rec, first X yrs
...
// Set values of fixed parameters or set initial guess of estimated parameters
 ...
 //Population		
  ...
  selpar_A50_cL1=set_selpar_A50_cL1(1);
  selpar_slope_cL1=set_selpar_slope_cL1(1);
  // selpar_A50_cL2=set_selpar_A50_cL2(1);
  // selpar_A50_cL3=set_selpar_A50_cL3(1);
  // selpar_slope_cL2=set_selpar_slope_cL2(1);
  // selpar_A502_cL2=set_selpar_A502_cL2(1);
  // selpar_slope2_cL2=set_selpar_slope2_cL2(1);
  ...
  selpar_afull_GR1=set_selpar_afull_GR1(1);
  selpar_sigma_GR1=set_selpar_sigma_GR1(1);
  selpar_A50_GR2=set_selpar_A50_GR2(1);
  selpar_slope_GR2=set_selpar_slope_GR2(1);
  selpar_afull_GR2=set_selpar_afull_GR2(1);
  selpar_sigma_GR2=set_selpar_sigma_GR2(1);  
  selpar_A50_GR3=set_selpar_A50_GR3(1);
  selpar_slope_GR3=set_selpar_slope_GR3(1);
  selpar_afull_GR3=set_selpar_afull_GR3(1);
  selpar_sigma_GR3=set_selpar_sigma_GR3(1);
  ...
  selpar_afull_CVT=set_selpar_afull_CVT(1);
  selpar_sigma_CVT=set_selpar_sigma_CVT(1);
  
  selpar_A50_vll=set_selpar_A50_vll(1);
...
FUNCTION get_selectivity
  ...
  sel_cH_vec=logistic(agebins, selpar_A50_cH1, selpar_slope_cH1);
  ...
  sel_cL_vec=logistic(agebins, selpar_A50_cL1, selpar_slope_cL1);
  // sel_cL_block2=logistic_double(agebins, selpar_A50_cL2, selpar_slope_cL2, selpar_A502_cL2,selpar_slope2_cL2);
  // sel_cL_block3=logistic_double(agebins, selpar_A50_cL3, selpar_slope_cL2, selpar_A502_cL2,selpar_slope2_cL2);
  // sel_cL_block1=sel_cL_block2;
  ...
  sel_GR_block1=logistic_exponential(agebins, selpar_A50_GR1, selpar_slope_GR1, selpar_sigma_GR1, selpar_afull_GR1);
  sel_GR_block2=logistic_exponential(agebins, selpar_A50_GR2, selpar_slope_GR2, selpar_sigma_GR2, selpar_afull_GR2);
  sel_GR_block3=logistic_exponential(agebins, selpar_A50_GR3, selpar_slope_GR3, selpar_sigma_GR3, selpar_afull_GR3);
  sel_CVT_vec=logistic_exponential(agebins, selpar_A50_CVT, selpar_slope_CVT, selpar_sigma_CVT, selpar_afull_CVT);
  sel_vll_vec=logistic(agebins, selpar_A50_vll, selpar_slope_vll);
...
FUNCTION get_mortality
  ...
  for (iyear=styr; iyear<=endyr; iyear++) 
  {
	...
	if(iyear>=styr_cL_L & iyear<=endyr_cL_L) //spans full time series
...
//Initialization
  ...
  //F_initial=sel_cH(styr)*mfexp(log_avg_F_cH+log_F_dev_init_cH)+
            //sel_cL(styr)*mfexp(log_avg_F_cL+log_F_dev_init_cL)+
            //sel_HB(styr)*mfexp(log_avg_F_HB+log_F_dev_init_HB)+
  F_init_cH_prop=mfexp(log_avg_F_cH+log_F_dev_init_cH)/(mfexp(log_avg_F_cH+log_F_dev_init_cH)+mfexp(log_avg_F_GR+log_F_dev_init_GR));
  F_init_GR_prop=mfexp(log_avg_F_GR+log_F_dev_init_GR)/(mfexp(log_avg_F_cH+log_F_dev_init_cH)+mfexp(log_avg_F_GR+log_F_dev_init_GR));
  
  F_initial=sel_cH(styr)*F_init*F_init_cH_prop+
            sel_GR(styr)*F_init*F_init_GR_prop;  //comm cL not operating at styr            //sel_GR(styr)*mfexp(log_avg_F_GR+log_F_dev_init_GR);			
...
//---Predicted CPUEs------------------------
 ...
 //SEFIS CVT cpue
  ...
  //MARMAP vll
  q_vll(styr_vll_cpue)=mfexp(log_q_vll); 
  for (iyear=styr_vll_cpue; iyear<=endyr_vll_cpue; iyear++)
  {   
    N_vll(iyear)=elem_prod(N_mdyr(iyear),sel_vll(iyear)); 
	pred_vll_cpue(iyear)=q_vll(iyear)*q_DD_fcn(iyear)*sum(N_vll(iyear));
    if (iyear<endyr_vll_cpue){q_vll(iyear+1)=q_vll(iyear)*mfexp(q_RW_log_dev_vll(iyear));}
  } 
...
FUNCTION get_age_comps
  ...
  //Commercial longline annual comps
  for (iyear=1;iyear<=nyr_cL_agec;iyear++) 
  {
    ErrorFree_cL_agec(iyear)=L_cL_num(yrs_cL_agec(iyear))/sum(L_cL_num(yrs_cL_agec(iyear)));  
    pred_cL_agec_allages(iyear)=age_error*(ErrorFree_cL_agec(iyear)/sum(ErrorFree_cL_agec(iyear)));   
    for (iage=1; iage<=nages_agec; iage++) {pred_cL_agec(iyear,iage)=pred_cL_agec_allages(iyear,iage);} 
    //for (iage=(nages_agec+1); iage<=nages; iage++) {pred_cL_agec(iyear,nages_agec)+=pred_cL_agec_allages(iyear,iage);} //plus group                             
  }
// // Commercial longline  pooled age comps
  // for (iyear=1;iyear<=nyr_cL_agec_pool;iyear++){
   
  // ErrorFree_cL_agec_yr(iyear)=L_cL_num(yrs_cL_agec_pool(iyear))/sum(L_cL_num(yrs_cL_agec_pool(iyear)));
  // pred_cL_agec_allages_yr(iyear)=age_error*(ErrorFree_cL_agec_yr(iyear)/sum(ErrorFree_cL_agec_yr(iyear)));							  
  // }  
  // pred_cL_agec.initialize();
  // for (iyear=1;iyear<=nyr_cL_agec_pool;iyear++)
    // {pred_cL_agec_allages(1) += (nfish_cL_agec_pool(iyear) * pred_cL_agec_allages_yr(iyear));}
  // pred_cL_agec_allages(1) = pred_cL_agec_allages(1)/sum(nfish_cL_agec_pool); //KWS moved this line out of the loop											   
 ...
 for (iyear=1;iyear<=nyr_vll_agec;iyear++)
  {
    ...
    for (iage=1; iage<=nages_agec; iage++) {pred_vll_agec(iyear,iage)=pred_vll_agec_allages(iyear,iage);} 
    //for (iage=(nages_agec+1); iage<=nages; iage++) {pred_vll_agec(iyear,nages_agec)+=pred_vll_agec_allages(iyear,iage);} //plus group                        
  }
...
FUNCTION get_weighted_current 
  ...
  wgt_wgted_L_denom=F_cH_prop+F_cL_prop+
				//F_HB_prop+
				F_GR_prop;  
...
//switch here if var_rec_dev <=dzero 
  ...
  for(iyear=styr; iyear<=endyr; iyear++)
  {
        L_total_klb_yr(iyear)=pred_cH_L_klb(iyear)+pred_cL_L_klb(iyear)+
		//pred_HB_L_klb(iyear)+
		pred_GR_L_klb(iyear);
        L_total_knum_yr(iyear)=pred_cH_L_knum(iyear)+pred_cL_L_knum(iyear)+pred_GR_L_knum(iyear);  //pred_HB_L_knum(iyear)+
  ...
  L_total_num=L_cH_num+L_cL_num+L_GR_num;   //landings at age in number fish -- L_HB_num+
  L_total_klb=L_cH_klb+L_cL_klb+L_GR_klb;   //landings at age in klb whole weight -- L_HB_klb+
 
  // D_total_num=D_GR_num;          //discards at age in number fish  -- D_HB_num+D_cH_num+
  // D_total_klb=D_GR_klb;            //discards at age in klb whole weight -- D_HB_klb+D_cH_klb+
...
//---Indices-------------------------------
  ...
  f_vll_cpue=0.0;
  f_vll_cpue=lk_lognormal(pred_vll_cpue, obs_vll_cpue, vll_cpue_cv, w_I_vll);
  fval+=f_vll_cpue;
...
//---Length comps-------------------------------
  ...
  //f_cL_lenc=lk_logistic_normal(nsamp_cL_lenc, pred_cL_lenc, obs_cL_lenc, nyr_cL_lenc, double(nlenbins), minSS_cL_lenc);
  f_cL_lenc=lk_dirichlet_multinomial(nsamp_cL_lenc, pred_cL_lenc, obs_cL_lenc, nyr_cL_lenc, double(nlenbins), minSS_cL_lenc, log_dm_cL_lc);
  fval+=f_cL_lenc;
  fval_data+=f_cL_lenc;
  ...
  //f_vll_lenc
  //f_vll_lenc=lk_robust_multinomial(nsamp_vll_lenc, pred_vll_lenc, obs_vll_lenc, nyr_vll_lenc, double(nlenbins), minSS_vll_lenc, w_lc_vll);
  //f_vll_lenc=lk_logistic_normal(nsamp_vll_lenc, pred_vll_lenc, obs_vll_lenc, nyr_vll_lenc, double(nlenbins), minSS_vll_lenc);
  // f_vll_lenc=lk_dirichlet_multinomial(nsamp_vll_lenc, pred_vll_lenc, obs_vll_lenc, nyr_vll_lenc, double(nlenbins), minSS_vll_lenc, log_dm_vll_lc);
  // fval+=f_vll_lenc;
...
//---Age comps-------------------------------
  ...
  //f_cL_agec
  //f_cL_agec=lk_robust_multinomial(nsamp_cL_agec, pred_cL_agec, obs_cL_agec, nyr_cL_agec, double(nages_agec), minSS_cL_agec, w_ac_cL);
  //f_cL_agec=lk_logistic_normal(nsamp_cL_agec, pred_cL_agec, obs_cL_agec, nyr_cL_agec, double(nages_agec), minSS_cL_agec);
  f_cL_agec=lk_dirichlet_multinomial(nsamp_cL_agec, pred_cL_agec, obs_cL_agec, nyr_cL_agec, double(nages_agec), minSS_cL_agec, log_dm_cL_ac);
  fval+=f_cL_agec;
  fval_data+=f_cL_agec;
  ...
  //f_vll_agec
  //f_vll_agec=lk_robust_multinomial(nsamp_vll_agec, pred_vll_agec, obs_vll_agec, nyr_vll_agec, double(nages_agec), minSS_vll_agec, w_ac_vll);
  //f_vll_agec=lk_logistic_normal(nsamp_vll_agec, pred_vll_agec, obs_vll_agec, nyr_vll_agec, double(nages_agec), minSS_vll_agec);
  f_vll_agec=lk_dirichlet_multinomial(nsamp_vll_agec, pred_vll_agec, obs_vll_agec, nyr_vll_agec, double(nages_agec), minSS_vll_agec, log_dm_vll_ac);
  //f_vll_agec=lk_dirichlet_multinomial(nsamp_vll_agec, pred_vll_agec, obs_vll_agec, nyr_vll_agec, double(nages_agec), minSS_vll_agec, log_dm_vll_ac);
  fval+=f_vll_agec;
  fval_data+=f_vll_agec;
...
//pdf type 1=none, 2=lognormal, 3=normal, 4=beta 
  ...
  f_priors+=neg_log_prior(selpar_A50_cL1,set_selpar_A50_cL1(5), set_selpar_A50_cL1(6), set_selpar_A50_cL1(7));
  f_priors+=neg_log_prior(selpar_slope_cL1,set_selpar_slope_cL1(5), set_selpar_slope_cL1(6), set_selpar_slope_cL1(7));
  ...
  // f_priors+=neg_log_prior(selpar_A502_cL2,set_selpar_A502_cL2(5), set_selpar_A502_cL2(6), set_selpar_A502_cL2(7));
  // f_priors+=neg_log_prior(selpar_slope2_cL2,set_selpar_slope2_cL2(5), set_selpar_slope2_cL2(6), set_selpar_slope2_cL2(7));
  ...
  f_priors+=neg_log_prior(selpar_afull_GR1,set_selpar_afull_GR1(5), set_selpar_afull_GR1(6), set_selpar_afull_GR1(7));
  f_priors+=neg_log_prior(selpar_sigma_GR1,set_selpar_sigma_GR1(5), set_selpar_sigma_GR1(6), set_selpar_sigma_GR1(7));
  ...
  f_priors+=neg_log_prior(selpar_afull_GR2,set_selpar_afull_GR2(5), set_selpar_afull_GR2(6), set_selpar_afull_GR2(7));
  f_priors+=neg_log_prior(selpar_sigma_GR2,set_selpar_sigma_GR2(5), set_selpar_sigma_GR2(6), set_selpar_sigma_GR2(7)); 
  ...
  f_priors+=neg_log_prior(selpar_afull_GR3,set_selpar_afull_GR3(5), set_selpar_afull_GR3(6), set_selpar_afull_GR3(7));
  f_priors+=neg_log_prior(selpar_sigma_GR3,set_selpar_sigma_GR3(5), set_selpar_sigma_GR3(6), set_selpar_sigma_GR3(7));
  ...
  f_priors+=neg_log_prior(selpar_A50_vll,set_selpar_A50_vll(5), set_selpar_A50_vll(6), set_selpar_A50_vll(7));
  ...
  f_priors+=neg_log_prior(log_q_vll,set_log_q_vll(5),set_log_q_vll(6),set_log_q_vll(7));
  ...
  f_priors+=neg_log_prior(log_dm_cL_ac,set_log_dm_cL_ac(5),set_log_dm_cL_ac(6),set_log_dm_cL_ac(7));
  ...
  f_priors+=neg_log_prior(log_dm_vll_ac,set_log_dm_vll_ac(5),set_log_dm_vll_ac(6),set_log_dm_vll_ac(7));
...
REPORT_SECTION
  ...
  if (last_phase())  
  {
	  ...
	  sdnr_I_vll=sdnr_lognormal(pred_vll_cpue, obs_vll_cpue, vll_cpue_cv, w_I_vll);
      ...
      //################################################################################################# 
	   ...
	   log_dm_vll_ac_out(8)=log_dm_vll_ac; log_dm_vll_ac_out(1,7)=set_log_dm_vll_ac;
       ...
       // selpar_A502_cL2_out(8)=selpar_A502_cL2; selpar_A502_cL2_out(1,7)=set_selpar_A502_cL2;
       // selpar_slope2_cL2_out(8)=selpar_slope2_cL2; selpar_slope2_cL2_out(1,7)=set_selpar_slope2_cL2;	  
	   ...
	   selpar_afull_GR1_out(8)=selpar_afull_GR1; selpar_afull_GR1_out(1,7)=set_selpar_afull_GR1;
	   selpar_sigma_GR1_out(8)=selpar_sigma_GR1; selpar_sigma_GR1_out(1,7)=set_selpar_sigma_GR1;
	   ...
	   selpar_afull_GR2_out(8)=selpar_afull_GR2; selpar_afull_GR2_out(1,7)=set_selpar_afull_GR2;
	   selpar_sigma_GR2_out(8)=selpar_sigma_GR2; selpar_sigma_GR2_out(1,7)=set_selpar_sigma_GR2;	   
	   ...
	   selpar_afull_GR3_out(8)=selpar_afull_GR3; selpar_afull_GR3_out(1,7)=set_selpar_afull_GR3;
	   selpar_sigma_GR3_out(8)=selpar_sigma_GR3; selpar_sigma_GR3_out(1,7)=set_selpar_sigma_GR3;
	   ...
	   selpar_A50_vll_out(8)=selpar_A50_vll; selpar_A50_vll_out(1,7)=set_selpar_A50_vll;
   ...
   #include "sg11_make_Robject_c1.cxx"   // write the R-compatible report
