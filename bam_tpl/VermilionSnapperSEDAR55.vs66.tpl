...
// Length Compositions 
init_int nyr_FST_lenc;
init_ivector yrs_FST_lenc(1,nyr_FST_lenc);
init_vector nsamp_FST_lenc(1,nyr_FST_lenc);
init_vector nfish_FST_lenc(1,nyr_FST_lenc);
init_matrix obs_FST_lenc(1,nyr_FST_lenc,1,nlenbins);
init_vector sel_FST_vec(1,nages);
//!!cout<<sel_FST_vec<<endl;
...
init_vector obs_cHTR_L(styr_cHTR_L,endyr_cHTR_L);
init_vector cHTR_L_cv(styr_cHTR_L,endyr_cHTR_L);
...
init_vector set_log_dm_cH_D_lc(1,7);  //Dirichlet-multinomial overdispersion parameter
//init_vector set_log_dm_FST_lc(1,7);   //Dirichlet-multinomial overdispersion parameter
...
//cout << set_log_dm_CVT_ac << endl;
// //Initial guesses or fixed values of estimated selectivity parameters

//init_number set_selpar_A50_FST; 
//init_number set_selpar_slope_FST;
//init_number set_selpar_A502_FST; 
//init_number set_selpar_slope2_FST;

init_vector set_selpar_A50_CVT(1,7); //was logistic exponential in update
init_vector set_selpar_slope_CVT(1,7);
init_vector set_selpar_A502_CVT(1,7); 
init_vector set_selpar_slope2_CVT(1,7);

init_vector set_selpar_Age1_CVT_logit(1,7);
init_vector set_selpar_Age2_CVT_logit(1,7);

init_vector set_selpar_A50_cH1(1,7);
init_vector set_selpar_slope_cH1(1,7);
init_vector set_selpar_A502_cH1(1,7);
init_vector set_selpar_slope2_cH1(1,7);
init_vector set_selpar_A50_cH2(1,7);
init_vector set_selpar_slope_cH2(1,7);
init_vector set_selpar_A502_cH2(1,7); 
init_vector set_selpar_slope2_cH2(1,7);

init_vector set_selpar_A50_cO1(1,7);
init_vector set_selpar_slope_cO1(1,7);
init_vector set_selpar_A502_cO1(1,7); 
init_vector set_selpar_slope2_cO1(1,7);

//init_vector set_selpar_A50_cHTR(1,7); 
//init_vector set_selpar_slope_cHTR(1,7);
...
init_vector set_selpar_A502_HB4(1,7); 
init_vector set_selpar_slope2_HB4(1,7);
...
init_vector set_selpar_A50_GR4(1,7); 
init_vector set_selpar_slope_GR4(1,7);
init_vector set_selpar_A502_GR4(1,7); 
init_vector set_selpar_slope2_GR4(1,7);

//Discard selectivities
init_vector set_sel_cH_D_2(1,nages);
init_vector set_selpar_Age2_cH_D2_logit(1,7);
init_vector set_selpar_A502_cH_D3(1,7);

init_number set_selpar_Age1_cH_D2;
init_number set_selpar_A50_cH_D3;  
init_number set_selpar_slope_cH_D3;
init_number set_selpar_slope2_cH_D3;
...
init_vector set_selpar_Age2_HB_D3_logit(1,7);
init_vector set_selpar_Age2_HB_D4_logit(1,7);

//init_vector set_selpar_age1logit_D(1,7);
//!!cout << set_selpar_Age2_HB_D4_logit << endl;
...
init_vector set_log_q_FST(1,7);     //catchability coefficient (log) for SERFS Florida-snapper trapindex  
init_vector set_log_q_CVT(1,7);     //catchability coefficient (log) for SERFS MARMAP trap index  

//--mean F's in log space --------------------------------
init_vector set_log_avg_F_cH(1,7);
init_vector set_log_avg_F_cO(1,7);
init_vector set_log_avg_F_cHTR(1,7);
...
init_vector set_log_F_dev_cHTR(1,3);
...
init_vector set_log_F_dev_cHTR_vals(styr_cHTR_L,endyr_cHTR_L);
...
init_number set_w_I_FST;        //weight for FST index
...
init_number set_w_lc_cH_D;		//weight for the headboat discard length comps   
init_number set_w_lc_FST;		//weight for the Florida-snapper trap length comps
...
//kcinit_number set_p_lenc_cH; 
//kcinit_number set_p_lenc_cO;
//kcinit_number set_p_lenc_HB2;
//kcinit_number set_p_lenc_HB3;
//kcinit_number set_p_lenc_HB4;
//kcinit_number set_p_lenc_GR2;  
//kcinit_number set_p_lenc_GR3;
//kcinit_number set_p_lenc_GR4;

//kcinit_number set_p_lenc_cH_D;
//kcinit_number set_p_lenc_HB_D2;
//kcinit_number set_p_lenc_HB_D3;
//kcinit_number set_p_lenc_HB_D4;
...
PARAMETER_SECTION
 ...
 LOCAL_CALCS
  ...
  const double log_dm_cH_lc_LO=set_log_dm_cH_lc(2); 
  const double log_dm_cH_lc_HI=set_log_dm_cH_lc(3); 
  const double log_dm_cH_lc_PH=set_log_dm_cH_lc(4);
  //const double log_dm_cO_lc_LO=set_log_dm_cO_lc(2); 
  //const double log_dm_cO_lc_HI=set_log_dm_cO_lc(3); 
  //const double log_dm_cO_lc_PH=set_log_dm_cO_lc(4);
  //const double log_dm_HB_lc_LO=set_log_dm_HB_lc(2); 
  //const double log_dm_HB_lc_HI=set_log_dm_HB_lc(3); 
  //const double log_dm_HB_lc_PH=set_log_dm_HB_lc(4);
  //const double log_dm_GR_lc_LO=set_log_dm_GR_lc(2); 
  //const double log_dm_GR_lc_HI=set_log_dm_GR_lc(3); 
  //const double log_dm_GR_lc_PH=set_log_dm_GR_lc(4);
  const double log_dm_HB_D_lc_LO=set_log_dm_HB_D_lc(2); 
  const double log_dm_HB_D_lc_HI=set_log_dm_HB_D_lc(3); 
  const double log_dm_HB_D_lc_PH=set_log_dm_HB_D_lc(4);
  const double log_dm_cH_D_lc_LO=set_log_dm_cH_D_lc(2); 
  const double log_dm_cH_D_lc_HI=set_log_dm_cH_D_lc(3); 
  const double log_dm_cH_D_lc_PH=set_log_dm_cH_D_lc(4);
  //const double log_dm_FST_lc_LO=set_log_dm_FST_lc(2); 
  //const double log_dm_FST_lc_HI=set_log_dm_FST_lc(3); 
  //const double log_dm_FST_lc_PH=set_log_dm_FST_lc(4);
  ////const double log_dm_CVT_lc_LO=set_log_dm_CVT_lc(2); 
  ////const double log_dm_CVT_lc_HI=set_log_dm_CVT_lc(3); 
  ////const double log_dm_CVT_lc_PH=set_log_dm_CVT_lc(4);
  const double log_dm_cH_ac_LO=set_log_dm_cH_ac(2); 
  const double log_dm_cH_ac_HI=set_log_dm_cH_ac(3); 
  const double log_dm_cH_ac_PH=set_log_dm_cH_ac(4);
  const double log_dm_HB_ac_LO=set_log_dm_HB_ac(2); 
  const double log_dm_HB_ac_HI=set_log_dm_HB_ac(3); 
  const double log_dm_HB_ac_PH=set_log_dm_HB_ac(4);
  const double log_dm_GR_ac_LO=set_log_dm_GR_ac(2); 
  const double log_dm_GR_ac_HI=set_log_dm_GR_ac(3); 
  const double log_dm_GR_ac_PH=set_log_dm_GR_ac(4);
  const double log_dm_CVT_ac_LO=set_log_dm_CVT_ac(2); 
  const double log_dm_CVT_ac_HI=set_log_dm_CVT_ac(3); 
  const double log_dm_CVT_ac_PH=set_log_dm_CVT_ac(4);
  
  const double selpar_A50_cH1_LO=set_selpar_A50_cH1(2); 
  const double selpar_A50_cH1_HI=set_selpar_A50_cH1(3); 
  const double selpar_A50_cH1_PH=set_selpar_A50_cH1(4);
  const double selpar_slope_cH1_LO=set_selpar_slope_cH1(2); 
  const double selpar_slope_cH1_HI=set_selpar_slope_cH1(3); 
  const double selpar_slope_cH1_PH=set_selpar_slope_cH1(4);
  const double selpar_A502_cH1_LO=set_selpar_A502_cH1(2); 
  const double selpar_A502_cH1_HI=set_selpar_A502_cH1(3); 
  const double selpar_A502_cH1_PH=set_selpar_A502_cH1(4);
  const double selpar_slope2_cH1_LO=set_selpar_slope2_cH1(2); 
  const double selpar_slope2_cH1_HI=set_selpar_slope2_cH1(3); 
  const double selpar_slope2_cH1_PH=set_selpar_slope2_cH1(4);
  const double selpar_A50_cH2_LO=set_selpar_A50_cH2(2); 
  const double selpar_A50_cH2_HI=set_selpar_A50_cH2(3); 
  const double selpar_A50_cH2_PH=set_selpar_A50_cH2(4);
  const double selpar_slope_cH2_LO=set_selpar_slope_cH2(2); 
  const double selpar_slope_cH2_HI=set_selpar_slope_cH2(3); 
  const double selpar_slope_cH2_PH=set_selpar_slope_cH2(4);
  const double selpar_A502_cH2_LO=set_selpar_A502_cH2(2); 
  const double selpar_A502_cH2_HI=set_selpar_A502_cH2(3); 
  const double selpar_A502_cH2_PH=set_selpar_A502_cH2(4);
  const double selpar_slope2_cH2_LO=set_selpar_slope2_cH2(2); 
  const double selpar_slope2_cH2_HI=set_selpar_slope2_cH2(3); 
  const double selpar_slope2_cH2_PH=set_selpar_slope2_cH2(4);

  const double selpar_A50_cO1_LO=set_selpar_A50_cO1(2); 
  const double selpar_A50_cO1_HI=set_selpar_A50_cO1(3); 
  const double selpar_A50_cO1_PH=set_selpar_A50_cO1(4);
  const double selpar_slope_cO1_LO=set_selpar_slope_cO1(2); 
  const double selpar_slope_cO1_HI=set_selpar_slope_cO1(3); 
  const double selpar_slope_cO1_PH=set_selpar_slope_cO1(4);
  const double selpar_A502_cO1_LO=set_selpar_A502_cO1(2); 
  const double selpar_A502_cO1_HI=set_selpar_A502_cO1(3); 
  const double selpar_A502_cO1_PH=set_selpar_A502_cO1(4);
  const double selpar_slope2_cO1_LO=set_selpar_slope2_cO1(2); 
  const double selpar_slope2_cO1_HI=set_selpar_slope2_cO1(3); 
  const double selpar_slope2_cO1_PH=set_selpar_slope2_cO1(4);

  const double selpar_A50_HB1_LO=set_selpar_A50_HB1(2); 
  const double selpar_A50_HB1_HI=set_selpar_A50_HB1(3); 
  const double selpar_A50_HB1_PH=set_selpar_A50_HB1(4);
  const double selpar_slope_HB1_LO=set_selpar_slope_HB1(2); 
  const double selpar_slope_HB1_HI=set_selpar_slope_HB1(3); 
  const double selpar_slope_HB1_PH=set_selpar_slope_HB1(4);
  const double selpar_A502_HB1_LO=set_selpar_A502_HB1(2); 
  const double selpar_A502_HB1_HI=set_selpar_A502_HB1(3); 
  const double selpar_A502_HB1_PH=set_selpar_A502_HB1(4);
  const double selpar_slope2_HB1_LO=set_selpar_slope2_HB1(2); 
  const double selpar_slope2_HB1_HI=set_selpar_slope2_HB1(3); 
  const double selpar_slope2_HB1_PH=set_selpar_slope2_HB1(4);
  const double selpar_A50_HB2_LO=set_selpar_A50_HB2(2); 
  const double selpar_A50_HB2_HI=set_selpar_A50_HB2(3); 
  const double selpar_A50_HB2_PH=set_selpar_A50_HB2(4);
  const double selpar_slope_HB2_LO=set_selpar_slope_HB2(2); 
  const double selpar_slope_HB2_HI=set_selpar_slope_HB2(3); 
  const double selpar_slope_HB2_PH=set_selpar_slope_HB2(4);
  const double selpar_A502_HB2_LO=set_selpar_A502_HB2(2); 
  const double selpar_A502_HB2_HI=set_selpar_A502_HB2(3); 
  const double selpar_A502_HB2_PH=set_selpar_A502_HB2(4);
  const double selpar_slope2_HB2_LO=set_selpar_slope2_HB2(2); 
  const double selpar_slope2_HB2_HI=set_selpar_slope2_HB2(3); 
  const double selpar_slope2_HB2_PH=set_selpar_slope2_HB2(4);
  const double selpar_A50_HB3_LO=set_selpar_A50_HB3(2); 
  const double selpar_A50_HB3_HI=set_selpar_A50_HB3(3); 
  const double selpar_A50_HB3_PH=set_selpar_A50_HB3(4);
  const double selpar_slope_HB3_LO=set_selpar_slope_HB3(2); 
  const double selpar_slope_HB3_HI=set_selpar_slope_HB3(3); 
  const double selpar_slope_HB3_PH=set_selpar_slope_HB3(4);
  const double selpar_A502_HB3_LO=set_selpar_A502_HB3(2); 
  const double selpar_A502_HB3_HI=set_selpar_A502_HB3(3); 
  const double selpar_A502_HB3_PH=set_selpar_A502_HB3(4);
  const double selpar_slope2_HB3_LO=set_selpar_slope2_HB3(2); 
  const double selpar_slope2_HB3_HI=set_selpar_slope2_HB3(3); 
  const double selpar_slope2_HB3_PH=set_selpar_slope2_HB3(4);
  const double selpar_A50_HB4_LO=set_selpar_A50_HB4(2); 
  const double selpar_A50_HB4_HI=set_selpar_A50_HB4(3); 
  const double selpar_A50_HB4_PH=set_selpar_A50_HB4(4);
  const double selpar_slope_HB4_LO=set_selpar_slope_HB4(2); 
  const double selpar_slope_HB4_HI=set_selpar_slope_HB4(3); 
  const double selpar_slope_HB4_PH=set_selpar_slope_HB4(4);
  const double selpar_A502_HB4_LO=set_selpar_A502_HB4(2); 
  const double selpar_A502_HB4_HI=set_selpar_A502_HB4(3); 
  const double selpar_A502_HB4_PH=set_selpar_A502_HB4(4);
  const double selpar_slope2_HB4_LO=set_selpar_slope2_HB4(2); 
  const double selpar_slope2_HB4_HI=set_selpar_slope2_HB4(3); 
  const double selpar_slope2_HB4_PH=set_selpar_slope2_HB4(4);

  const double selpar_A50_GR2_LO=set_selpar_A50_GR2(2); 
  const double selpar_A50_GR2_HI=set_selpar_A50_GR2(3); 
  const double selpar_A50_GR2_PH=set_selpar_A50_GR2(4);
  const double selpar_slope_GR2_LO=set_selpar_slope_GR2(2); 
  const double selpar_slope_GR2_HI=set_selpar_slope_GR2(3); 
  const double selpar_slope_GR2_PH=set_selpar_slope_GR2(4);
  const double selpar_A50_GR3_LO=set_selpar_A50_GR3(2); 
  const double selpar_A50_GR3_HI=set_selpar_A50_GR3(3); 
  const double selpar_A50_GR3_PH=set_selpar_A50_GR3(4);
  const double selpar_slope_GR3_LO=set_selpar_slope_GR3(2); 
  const double selpar_slope_GR3_HI=set_selpar_slope_GR3(3); 
  const double selpar_slope_GR3_PH=set_selpar_slope_GR3(4);
  const double selpar_A502_GR3_LO=set_selpar_A502_GR3(2); 
  const double selpar_A502_GR3_HI=set_selpar_A502_GR3(3); 
  const double selpar_A502_GR3_PH=set_selpar_A502_GR3(4);
  const double selpar_slope2_GR3_LO=set_selpar_slope2_GR3(2); 
  const double selpar_slope2_GR3_HI=set_selpar_slope2_GR3(3); 
  const double selpar_slope2_GR3_PH=set_selpar_slope2_GR3(4);
  const double selpar_A50_GR4_LO=set_selpar_A50_GR4(2); 
  const double selpar_A50_GR4_HI=set_selpar_A50_GR4(3); 
  const double selpar_A50_GR4_PH=set_selpar_A50_GR4(4);
  const double selpar_slope_GR4_LO=set_selpar_slope_GR4(2); 
  const double selpar_slope_GR4_HI=set_selpar_slope_GR4(3); 
  const double selpar_slope_GR4_PH=set_selpar_slope_GR4(4);
  const double selpar_A502_GR4_LO=set_selpar_A502_GR4(2); 
  const double selpar_A502_GR4_HI=set_selpar_A502_GR4(3); 
  const double selpar_A502_GR4_PH=set_selpar_A502_GR4(4);
  const double selpar_slope2_GR4_LO=set_selpar_slope2_GR4(2); 
  const double selpar_slope2_GR4_HI=set_selpar_slope2_GR4(3); 
  const double selpar_slope2_GR4_PH=set_selpar_slope2_GR4(4);

  const double selpar_A50_CVT_LO=set_selpar_A50_CVT(2); 
  const double selpar_A50_CVT_HI=set_selpar_A50_CVT(3); 
  const double selpar_A50_CVT_PH=set_selpar_A50_CVT(4);
  const double selpar_slope_CVT_LO=set_selpar_slope_CVT(2); 
  const double selpar_slope_CVT_HI=set_selpar_slope_CVT(3); 
  const double selpar_slope_CVT_PH=set_selpar_slope_CVT(4);
  const double selpar_A502_CVT_LO=set_selpar_A502_CVT(2); 
  const double selpar_A502_CVT_HI=set_selpar_A502_CVT(3); 
  const double selpar_A502_CVT_PH=set_selpar_A502_CVT(4);
  const double selpar_slope2_CVT_LO=set_selpar_slope2_CVT(2); 
  const double selpar_slope2_CVT_HI=set_selpar_slope2_CVT(3); 
  const double selpar_slope2_CVT_PH=set_selpar_slope2_CVT(4);
  const double selpar_Age1_CVT_logit_LO=set_selpar_Age1_CVT_logit(2); 
  const double selpar_Age1_CVT_logit_HI=set_selpar_Age1_CVT_logit(3); 
  const double selpar_Age1_CVT_logit_PH=set_selpar_Age1_CVT_logit(4);
  const double selpar_Age2_CVT_logit_LO=set_selpar_Age2_CVT_logit(2); 
  const double selpar_Age2_CVT_logit_HI=set_selpar_Age2_CVT_logit(3); 
  const double selpar_Age2_CVT_logit_PH=set_selpar_Age2_CVT_logit(4);
  
  const double selpar_Age2_cH_D2_logit_LO=set_selpar_Age2_cH_D2_logit(2); 
  const double selpar_Age2_cH_D2_logit_HI=set_selpar_Age2_cH_D2_logit(3); 
  const double selpar_Age2_cH_D2_logit_PH=set_selpar_Age2_cH_D2_logit(4);
  
  const double selpar_A502_cH_D3_LO=set_selpar_A502_cH_D3(2); 
  const double selpar_A502_cH_D3_HI=set_selpar_A502_cH_D3(3); 
  const double selpar_A502_cH_D3_PH=set_selpar_A502_cH_D3(4);
  
  const double selpar_Age2_HB_D3_logit_LO=set_selpar_Age2_HB_D3_logit(2); 
  const double selpar_Age2_HB_D3_logit_HI=set_selpar_Age2_HB_D3_logit(3); 
  const double selpar_Age2_HB_D3_logit_PH=set_selpar_Age2_HB_D3_logit(4);
  
  const double selpar_Age2_HB_D4_logit_LO=set_selpar_Age2_HB_D4_logit(2); 
  const double selpar_Age2_HB_D4_logit_HI=set_selpar_Age2_HB_D4_logit(3); 
  const double selpar_Age2_HB_D4_logit_PH=set_selpar_Age2_HB_D4_logit(4);
  ...
  const double log_q_FST_LO=set_log_q_FST(2); const double log_q_FST_HI=set_log_q_FST(3); const double log_q_FST_PH=set_log_q_FST(4);
  ...
  const double log_avg_F_cHTR_LO=set_log_avg_F_cHTR(2); const double log_avg_F_cHTR_HI=set_log_avg_F_cHTR(3); const double log_avg_F_cHTR_PH=set_log_avg_F_cHTR(4);
  ...
  const double log_F_dev_cHTR_LO=set_log_F_dev_cHTR(1); const double log_F_dev_cHTR_HI=set_log_F_dev_cHTR(2); const double log_F_dev_cHTR_PH=set_log_F_dev_cHTR(3);   
...
////--------------Growth--------------------------------------------------------------------------- 
  ...
  matrix len_cHTR_mm(styr,endyr,1,nages);          //mean length at age of commercial other landings in mm 
  matrix wholewgt_cHTR_klb(styr,endyr,1,nages);    //whole wgt of commercial other landings in 1000 lb 
  ...
  matrix lenprob_cH(1,nages,1,nlenbins);   //distn of size at age in cH   kc added
  matrix lenprob_cO(1,nages,1,nlenbins);   //distn of size at age in cO   kc added
  //matrix lenprob_HB(1,nages,1,nlenbins);   //distn of size at age in HB   kc added
  matrix lenprob_HB_D(1,nages,1,nlenbins); //distn of size at age in HB_D  kc added
 // matrix lenprob_GR(1,nages,1,nlenbins);   //distn of size at age in GR   kc added
  matrix lenprob_cH_D(1,nages,1,nlenbins);   //distn of size at age in cH_D   kc added
  matrix lenprob_FST(1,nages,1,nlenbins); //distn of size at age in FST   kc added
  //matrix lenprob_CVT(1,nages,1,nlenbins); //distn of size at age in CVT   kc added

  //matrix lenprob_cH1(1,nages,1,nlenbins);     //distn of size at age in cH  kc
  //matrix lenprob_cH2(1,nages,1,nlenbins);     //distn of size at age in cH  kc
  //matrix lenprob_cO1(1,nages,1,nlenbins);     //distn of size at age in cO  kc
  //matrix lenprob_cO2(1,nages,1,nlenbins);     //distn of size at age in cO  kc
  //matrix lenprob_HB1(1,nages,1,nlenbins);     //distn of size at age in HB   kc
  //matrix lenprob_HB2(1,nages,1,nlenbins);     //distn of size at age in HB   kc
  //matrix lenprob_HB3(1,nages,1,nlenbins);     //distn of size at age in HB   kc
  //matrix lenprob_HB4(1,nages,1,nlenbins);     //distn of size at age in HB   kc
  //matrix lenprob_HB_D2(1,nages,1,nlenbins);   //distn of size at age in HB discards kc  
  //matrix lenprob_HB_D3(1,nages,1,nlenbins);   //distn of size at age in HB discards kc 
  //matrix lenprob_HB_D4(1,nages,1,nlenbins);   //distn of size at age in HB discards kc 
  //matrix lenprob_GR1(1,nages,1,nlenbins);     //distn of size at age in GR  kc
  //matrix lenprob_GR2(1,nages,1,nlenbins);     //distn of size at age in GR  kc
  //matrix lenprob_GR3(1,nages,1,nlenbins);     //distn of size at age in GR  kc
  //matrix lenprob_GR4(1,nages,1,nlenbins);     //distn of size at age in GR  kc
  //matrix lenprob_cH_D2(1,nages,1,nlenbins);   //distn of size at age in HB discards kc  
  //matrix lenprob_cH_D3(1,nages,1,nlenbins);   //distn of size at age in HB discards  kc
  //matrix lenprob_FST(1,nages,1,nlenbins);    //distn of size at age in FST  kc
  //matrix lenprob_CVT(1,nages,1,nlenbins);    //distn of size at age in CVT  kc
...
//----Predicted length and age compositions
  ...
  matrix pred_FST_lenc(1,nyr_FST_lenc,1,nlenbins); 
 ...
 //p_lenc_fishery pars require age comp and length comp data for estimation
  //kc number p_lenc_cH;
  //kc number p_lenc_cO;
  //kc number p_lenc_HB2;
  //kc number p_lenc_HB3;
  //kc number p_lenc_HB4;
  //kc number p_lenc_GR2;
  //kc number p_lenc_GR3;
  //kc number p_lenc_GR4;
    
  //kc number p_lenc_cH_D;
  //kc number p_lenc_HB_D2; //no comp data in this period, this par only used for avg weight
  //kc number p_lenc_HB_D3;
  //kcnumber p_lenc_HB_D4;
...
//Nfish used in MCB analysis (not used in fitting)
  ...
  vector nfish_FST_lenc_allyr(styr,endyr);
...
//Computed effective sample size for output (not used in fitting)
  ...
  vector neff_cH_D_lenc_allyr(styr,endyr);  
  //vector neff_GR_lenc_allyr(styr,endyr);
  vector neff_FST_lenc_allyr(styr,endyr);
...
//---Stock-Recruit Function (Beverton-Holt, steepness parameterization)----------
 ...
 // init_bounded_number log_dm_GR_lc(log_dm_GR_lc_LO,log_dm_GR_lc_HI,log_dm_GR_lc_PH);
  ...
  //init_bounded_number log_dm_FST_lc(log_dm_FST_lc_LO,log_dm_FST_lc_HI,log_dm_FST_lc_PH);
...
//Florida Snapper Trap index selectivity  
  ...
  //number selpar_A50_FST;
  //number selpar_slope_FST;
  //number selpar_A502_FST;
...
//SEFIS index selectivity  
  ...
  init_bounded_number selpar_Age1_CVT_logit(selpar_Age1_CVT_logit_LO,selpar_Age1_CVT_logit_HI,selpar_Age1_CVT_logit_PH);
  init_bounded_number selpar_Age2_CVT_logit(selpar_Age2_CVT_logit_LO,selpar_Age2_CVT_logit_HI,selpar_Age2_CVT_logit_PH);
  
  number selpar_Age2_CVT; //age 1 value in arithmetic space, after logit backtransform 
  number selpar_Age1_CVT; //age 1 value in arithmetic space, after logit backtransform 
  ...
  vector selpar_Age1_CVT_logit_out(1,8);
  vector selpar_Age2_CVT_logit_out(1,8);
  ...
  number selpar_A502_cH1;
  number selpar_slope2_cH1;
  
  //init_bounded_number selpar_A502_cH1(selpar_A502_cH1_LO,selpar_A502_cH1_HI,selpar_A502_cH1_PH);
  //init_bounded_number selpar_slope2_cH1(selpar_slope2_cH1_LO,selpar_slope2_cH1_HI,selpar_slope2_cH1_PH);
  ...
  number selpar_A502_cH2;
  number selpar_slope2_cH2;
  
  //init_bounded_number selpar_A502_cH2(selpar_A502_cH2_LO,selpar_A502_cH2_HI,selpar_A502_cH2_PH);
  //init_bounded_number selpar_slope2_cH2(selpar_slope2_cH2_LO,selpar_slope2_cH2_HI,selpar_slope2_cH2_PH);
  
  vector selpar_A50_cH1_out(1,8);
  vector selpar_slope_cH1_out(1,8);
  //vector selpar_A502_cH1_out(1,8);
  //vector selpar_slope2_cH1_out(1,8);
  vector selpar_A50_cH2_out(1,8);
  vector selpar_slope_cH2_out(1,8);
  //vector selpar_A502_cH2_out(1,8);
  //vector selpar_slope2_cH2_out(1,8);
  
 //Commercial handline discards
  matrix sel_cH_D(styr,endyr,1,nages);  
  //!!cout<<sel_cH_D<<endl;
  number selpar_Age1_cH_D2;
  number selpar_Age2_cH_D2;
  number selpar_A50_cH_D3;  
  number selpar_slope_cH_D3;
  number selpar_slope2_cH_D3;
  vector sel_cH_D_2(1,nages); //sel in period 2  
  vector sel_cH_D_3(1,nages); //sel in period 3  
  
  init_bounded_number selpar_Age2_cH_D2_logit(selpar_Age2_cH_D2_logit_LO,selpar_Age2_cH_D2_logit_HI,selpar_Age2_cH_D2_logit_PH);
  init_bounded_number selpar_A502_cH_D3(selpar_A502_cH_D3_LO,selpar_A502_cH_D3_HI,selpar_A502_cH_D3_PH);
  
  vector selpar_Age2_cH_D2_logit_out(1,8);
  vector selpar_A502_cH_D3_out(1,8);
  ...
  init_bounded_number selpar_A50_cO1(selpar_A50_cO1_LO,selpar_A50_cO1_HI,selpar_A50_cO1_PH);
  init_bounded_number selpar_slope_cO1(selpar_slope_cO1_LO,selpar_slope_cO1_HI,selpar_slope_cO1_PH);
  init_bounded_number selpar_A502_cO1(selpar_A502_cO1_LO,selpar_A502_cO1_HI,selpar_A502_cO1_PH);
  init_bounded_number selpar_slope2_cO1(selpar_slope2_cO1_LO,selpar_slope2_cO1_HI,selpar_slope2_cO1_PH);
  
  number selpar_A50_cO2;
  number selpar_slope_cO2;
  number selpar_A502_cO2;
  number selpar_slope2_cO2;
  
  vector selpar_A50_cO1_out(1,8);
  vector selpar_slope_cO1_out(1,8);
  vector selpar_A502_cO1_out(1,8);
  vector selpar_slope2_cO1_out(1,8);
  ...
  init_bounded_number selpar_A502_HB4(selpar_A502_HB4_LO,selpar_A502_HB4_HI,selpar_A502_HB4_PH);
  init_bounded_number selpar_slope2_HB4(selpar_slope2_HB4_LO,selpar_slope2_HB4_HI,selpar_slope2_HB4_PH);
  ...
  vector selpar_A502_HB4_out(1,8);
  vector selpar_slope2_HB4_out(1,8);

  //Headboat discards
  matrix sel_HB_D(styr,endyr,1,nages);
  number selpar_Age1_HB_D3; //period 1,2
  number selpar_Age1_HB_D4; //period 1,2 
  number selpar_Age2_HB_D3;
  number selpar_Age2_HB_D4;
  
  init_bounded_number selpar_Age2_HB_D3_logit(selpar_Age2_HB_D3_logit_LO,selpar_Age2_HB_D3_logit_HI,selpar_Age2_HB_D3_logit_PH);
  init_bounded_number selpar_Age2_HB_D4_logit(selpar_Age2_HB_D4_logit_LO,selpar_Age2_HB_D4_logit_HI,selpar_Age2_HB_D4_logit_PH);
  ...
  vector selpar_Age2_HB_D3_logit_out(1,8);
  vector selpar_Age2_HB_D4_logit_out(1,8);
  ...
  init_bounded_number selpar_slope2_GR3(selpar_slope2_GR3_LO,selpar_slope2_GR3_HI,selpar_slope2_GR3_PH);
  init_bounded_number selpar_A50_GR4(selpar_A50_GR4_LO,selpar_A50_GR4_HI,selpar_A50_GR4_PH);
  init_bounded_number selpar_slope_GR4(selpar_slope_GR4_LO,selpar_slope_GR4_HI,selpar_slope_GR4_PH);
  init_bounded_number selpar_A502_GR4(selpar_A502_GR4_LO,selpar_A502_GR4_HI,selpar_A502_GR4_PH);
  init_bounded_number selpar_slope2_GR4(selpar_slope2_GR4_LO,selpar_slope2_GR4_HI,selpar_slope2_GR4_PH);
  ...
  vector selpar_A50_GR4_out(1,8);
  vector selpar_slope_GR4_out(1,8);  
  vector selpar_A502_GR4_out(1,8);
  vector selpar_slope2_GR4_out(1,8);
  
//General rec discards - get the same selex as HB
...
//-------CPUE Predictions--------------------------------
  ...
  vector pred_FST_cpue(styr_FST_cpue,endyr_FST_cpue);                //predicted Florida snapper trap index (number fish per effort)
  matrix N_FST(styr_FST_cpue,endyr_FST_cpue,1,nages);                //used to compute SERFS index
...
//---Catchability (CPUE q's)----------------------------------------------------------
  ...
  init_bounded_number log_q_FST(log_q_FST_LO,log_q_FST_HI,log_q_FST_PH);
...
//kc vector q_RW_log_dev_cH(styr_cH_cpue,endyr_cH_cpue-1); 
//kc vector q_RW_log_dev_HB(styr_HB_cpue,endyr_HB_cpue-1);
//kc vector q_RW_log_dev_GR(styr_GR_cpue,endyr_GR_cpue-1);
 ...
 init_bounded_vector q_RW_log_dev_GR(styr_GR_cpue,endyr_GR_cpue-1,log_RWq_LO,log_RWq_HI,log_RWq_PH);
 vector q_RW_log_dev_FST(styr_FST_cpue,endyr_FST_cpue-1); 
...
//Fishery dependent catchability over time, may be constant
 ...
 vector q_FST(styr_FST_cpue,endyr_FST_cpue); 
...
//---Landings in numbers (total or 1000 fish) and in wgt (whole klb)--------------------------------------------------
  ...
  vector pred_cHTR_L_knum(styr,endyr);     //yearly landings in 1000 fish summed over ages  
  vector pred_cHTR_L_klb(styr,endyr);      //yearly landings in 1000 lb whole summed over ages
...
////---MSY calcs----------------------------------------------------------------------------
  ...
  number F_cHTR_prop;      //proportion of F_sum attributable to HTR, last X=selpar_n_yrs_wgted yrs 
...
////--------Mortality------------------------------------------------------------------
  ...
  init_bounded_number log_avg_F_cHTR(log_avg_F_cHTR_LO,log_avg_F_cHTR_HI,log_avg_F_cHTR_PH);
  vector log_avg_F_cHTR_out(1,8);  
  init_bounded_dev_vector log_F_dev_cHTR(styr_cHTR_L,endyr_cHTR_L,log_F_dev_cHTR_LO,log_F_dev_cHTR_HI,log_F_dev_cHTR_PH);
  vector log_F_dev_cHTR_out(styr_cHTR_L,endyr_cHTR_L);
  matrix F_cHTR(styr,endyr,1,nages);
  vector F_cHTR_out(styr,endyr);        //used for intermediate calculations in fcn get_mortality
  number log_F_dev_init_cHTR;
  number log_F_dev_end_cHTR;
...
// Set values of fixed parameters or set initial guess of estimated parameters
 ...
 // log_dm_GR_lc=set_log_dm_GR_lc(1);
  ...
  //log_dm_FST_lc=set_log_dm_FST_lc(1);
   ...
   if (set_q_rate_phase<0 & q_rate!=0.0)
  {
    for (iyear=styr_cH_cpue; iyear<=endyr_cH_cpue; iyear++)
      {   if (iyear>styr_cH_cpue & iyear <=2008)  //changed from 2003 KC 
          ...
          if (iyear>2008) {q_rate_fcn_cH(iyear)=q_rate_fcn_cH(iyear-1);} 
      }   
    for (iyear=styr_HB_cpue; iyear<=endyr_HB_cpue; iyear++)
      {   if (iyear>styr_HB_cpue & iyear <=2008)  //changed from 2003 KC 
          ...
          if (iyear>2008) {q_rate_fcn_HB(iyear)=q_rate_fcn_HB(iyear-1);} 
      }   
     for (iyear=styr_GR_cpue; iyear<=endyr_GR_cpue; iyear++)
       {   if (iyear>styr_GR_cpue & iyear <=2008)  //changed from 2003 KC 
           ...
           if (iyear>2008) {q_rate_fcn_GR(iyear)=q_rate_fcn_GR(iyear-1);} 
       }   
 ...
 //w_ac_CVT=set_w_ac_CVT;  
  ...
  log_avg_F_cHTR=set_log_avg_F_cHTR(1);
  ...
  log_F_dev_cHTR=set_log_F_dev_cHTR_vals;
  ...
  selpar_A502_cH1=set_selpar_A502_cH1(1);
  selpar_slope2_cH1=set_selpar_slope2_cH1(1);
  selpar_A50_cH2=set_selpar_A50_cH2(1);
  selpar_slope_cH2=set_selpar_slope_cH2(1);
  selpar_A502_cH2=set_selpar_A50_cH2(1);
  selpar_slope2_cH2=set_selpar_slope2_cH2(1);
  
  selpar_A50_cO1=set_selpar_A50_cO1(1);
  selpar_slope_cO1=set_selpar_slope_cO1(1);
  selpar_A502_cO1=set_selpar_A502_cO1(1);
  selpar_slope2_cO1=set_selpar_slope2_cO1(1);
  ...
  selpar_A502_HB4=set_selpar_A502_HB4(1);
  selpar_slope2_HB4=set_selpar_slope2_HB4(1);
  ...
  selpar_A50_GR4=set_selpar_A50_GR4(1);
  selpar_slope_GR4=set_selpar_slope_GR4(1);
  selpar_A502_GR4=set_selpar_A502_GR4(1);
  selpar_slope2_GR4=set_selpar_slope2_GR4(1);
  ...
  selpar_Age1_CVT_logit=set_selpar_Age1_CVT_logit(1);  
  selpar_Age2_CVT_logit=set_selpar_Age2_CVT_logit(1);  
  
  //Discards
  //selpar_age1logit_D=set_selpar_age1logit_D(1);
  selpar_Age2_cH_D2_logit=set_selpar_Age2_cH_D2_logit(1);  
  selpar_A502_cH_D3=set_selpar_A502_cH_D3(1);
  sel_cH_D_2=set_sel_cH_D_2;
  selpar_A50_cH_D3=set_selpar_A50_cH_D3;  
  selpar_slope_cH_D3=set_selpar_slope_cH_D3;
  selpar_slope2_cH_D3=set_selpar_slope2_cH_D3;
  ...
  selpar_Age2_HB_D3_logit=set_selpar_Age2_HB_D3_logit(1);
  selpar_Age2_HB_D4_logit=set_selpar_Age2_HB_D4_logit(1);
 ...
 //kc p_lenc_cH=set_p_lenc_cH;
 //kc p_lenc_cO=set_p_lenc_cO;
 //kc p_lenc_HB2=set_p_lenc_HB2;
 //kc p_lenc_HB3=set_p_lenc_HB3;
 //kc p_lenc_HB4=set_p_lenc_HB4;  
 //kc p_lenc_GR2=set_p_lenc_GR2;
 //kc p_lenc_GR3=set_p_lenc_GR3;
 //kc p_lenc_GR4=set_p_lenc_GR4;
   
 //kc p_lenc_cH_D=set_p_lenc_cH_D;
 //kc p_lenc_HB_D2=set_p_lenc_HB_D2;
 //kc p_lenc_HB_D3=set_p_lenc_HB_D3; 
 //k p_lenc_HB_D4=set_p_lenc_HB_D4;  
...
//             nfish_GR_lenc_allyr(yrs_GR_lenc(iyear))=nfish_GR_lenc(iyear);}}
      for (iyear=1; iyear<=nyr_FST_lenc; iyear++)                           
         {if (nsamp_FST_lenc(iyear)>=minSS_FST_lenc)
            {nsamp_FST_lenc_allyr(yrs_FST_lenc(iyear))=nsamp_FST_lenc(iyear);
             nfish_FST_lenc_allyr(yrs_FST_lenc(iyear))=nfish_FST_lenc(iyear);}}
...
//fill in F's, Catch matrices, and log rec dev with zero's
  F_cHTR.initialize(); L_cHTR_num.initialize();
  ...
  sel_FST.initialize();
  sel_CVT.initialize();
  //sel_cH_D.initialize();  //kc
  sel_HB_D.initialize();  //kc
...
//  //fishery specific length probs, assumed normal prior to size limits
  ...
  //kc lenprob_cH1=lenprob;
  //kc lenprob_cH2=lenprob; //values will be adjusted based on size limit 
  //kc lenprob_cO1=lenprob; 
  //kc lenprob_cO2=lenprob; //values will be adjusted based on size limit 
  //kc lenprob_HB1=lenprob; 
  //kc lenprob_HB2=lenprob; //values will be adjusted based on size limit 
  //kc lenprob_HB3=lenprob; //values will be adjusted based on size limit 
  //kc lenprob_HB4=lenprob; //values will be adjusted based on size limit  
  //kc lenprob_GR1=lenprob; 
  //kc lenprob_GR2=lenprob; //values will be adjusted based on size limit 
  //kc lenprob_GR3=lenprob; //values will be adjusted based on size limit 
  //kc lenprob_GR4=lenprob; //values will be adjusted based on size limit 
  //kc lenprob_FST=lenprob; 
  
  //kc lenprob_cH_D2=lenprob; //values will be adjusted based on size limit 
  //kc lenprob_cH_D3=lenprob;  
  //kc lenprob_HB_D2=lenprob; //values will be adjusted based on size limit 
  //kc lenprob_HB_D3=lenprob; //values will be adjusted based on size limit 
  //kc lenprob_HB_D4=lenprob; //values will be adjusted based on size limit   
...
//          lenprob_GR2(iage,ilen)=p_lenc_GR2*lenprob(iage,ilen);
          
//        }
//        if (lenbins(ilen) < sizelim2)
//        {
//          lenprob_HB3(iage,ilen)=p_lenc_HB3*lenprob(iage,ilen);
//          lenprob_GR3(iage,ilen)=p_lenc_GR3*lenprob(iage,ilen);
          
//        }
//        if (lenbins(ilen) < sizelim3)
//        {
//          lenprob_cH2(iage,ilen)=p_lenc_cH*lenprob(iage,ilen);
//          lenprob_cO2(iage,ilen)=p_lenc_cO*lenprob(iage,ilen);
//          lenprob_HB4(iage,ilen)=p_lenc_HB4*lenprob(iage,ilen);
//          lenprob_GR4(iage,ilen)=p_lenc_GR4*lenprob(iage,ilen);
...
//        if (lenbins(ilen) > sizelim3)
//        {
//          lenprob_cH_D2(iage,ilen)=p_lenc_cH_D*lenprob(iage,ilen);
...
//    lenprob_cH2(iage)/=sum(lenprob_cH2(iage));   //standardize
//    lenprob_cO2(iage)/=sum(lenprob_cO2(iage));   //standardize
//    lenprob_HB2(iage)/=sum(lenprob_HB2(iage));       //standardize
//    lenprob_GR2(iage)/=sum(lenprob_GR2(iage)); //standardize
//    lenprob_HB3(iage)/=sum(lenprob_HB3(iage));       //standardize
//    lenprob_GR3(iage)/=sum(lenprob_GR3(iage)); //standardize
//    lenprob_HB4(iage)/=sum(lenprob_HB4(iage));       //standardize
//    lenprob_GR4(iage)/=sum(lenprob_GR4(iage)); //standardize
    
//    lenprob_cH_D2(iage)/=sum(lenprob_cH_D2(iage)); //standardize
...
FUNCTION get_weight_at_age_landings  ///***in whole weight
  ...
  for (iyear=styr; iyear<=endyr; iyear++)
  {
    ...
    wholewgt_cHTR_klb(iyear)=wgt_klb;
  ...
  //kc      {len_HB_D_mm(iyear,iage)=sum(elem_prod(lenprob_HB_D2(iage),lenbins));}
  //kc  wholewgt_HB_D_klb(iyear)=g2klb*wgtpar_a*pow(len_HB_D_mm(iyear),wgtpar_b);
  //kc }  
 ...
 //kc   for (iage=1;iage<=nages; iage++)
 //kc   {
 //kc   len_cH_mm(iyear,iage)=sum(elem_prod(lenprob_cH2(iage),lenbins)); 
 //kc   len_cO_mm(iyear,iage)=sum(elem_prod(lenprob_cO2(iage),lenbins)); 
 //kc   len_HB_mm(iyear,iage)=sum(elem_prod(lenprob_HB2(iage),lenbins));     
 //kc   len_GR_mm(iyear,iage)=sum(elem_prod(lenprob_GR2(iage),lenbins));     
 //kc   len_cH_D_mm(iyear,iage)=sum(elem_prod(lenprob_cH_D2(iage),lenbins)); 
 //kc   len_HB_D_mm(iyear,iage)=sum(elem_prod(lenprob_HB_D2(iage),lenbins));       
 //kc   }
 //kc   wholewgt_cH_klb(iyear)=g2klb*wgtpar_a*pow(len_cH_mm(iyear),wgtpar_b);
 //kc   wholewgt_cO_klb(iyear)=g2klb*wgtpar_a*pow(len_cO_mm(iyear),wgtpar_b);
 //kc   wholewgt_HB_klb(iyear)=g2klb*wgtpar_a*pow(len_HB_mm(iyear),wgtpar_b);
 //kc   wholewgt_GR_klb(iyear)=g2klb*wgtpar_a*pow(len_GR_mm(iyear),wgtpar_b);
 //kc   wholewgt_cH_D_klb(iyear)=g2klb*wgtpar_a*pow(len_cH_D_mm(iyear),wgtpar_b);  
 //kc   wholewgt_HB_D_klb(iyear)=g2klb*wgtpar_a*pow(len_HB_D_mm(iyear),wgtpar_b);           
 // }
 ...
 //   for (iage=1;iage<=nages; iage++)
 //   {
 //   len_cH_mm(iyear,iage)=sum(elem_prod(lenprob_cH2(iage),lenbins)); 
 //   len_cO_mm(iyear,iage)=sum(elem_prod(lenprob_cO2(iage),lenbins)); 
 //   len_HB_mm(iyear,iage)=sum(elem_prod(lenprob_HB3(iage),lenbins));     
 //   len_GR_mm(iyear,iage)=sum(elem_prod(lenprob_GR3(iage),lenbins));     
 //   len_cH_D_mm(iyear,iage)=sum(elem_prod(lenprob_cH_D2(iage),lenbins)); 
 //   len_HB_D_mm(iyear,iage)=sum(elem_prod(lenprob_HB_D3(iage),lenbins));
 //   }
 //   wholewgt_cH_klb(iyear)=g2klb*wgtpar_a*pow(len_cH_mm(iyear),wgtpar_b);
 //   wholewgt_cO_klb(iyear)=g2klb*wgtpar_a*pow(len_cO_mm(iyear),wgtpar_b); 
 //   wholewgt_HB_klb(iyear)=g2klb*wgtpar_a*pow(len_HB_mm(iyear),wgtpar_b);
 //   wholewgt_GR_klb(iyear)=g2klb*wgtpar_a*pow(len_GR_mm(iyear),wgtpar_b);       
 //   wholewgt_cH_D_klb(iyear)=g2klb*wgtpar_a*pow(len_cH_D_mm(iyear),wgtpar_b); 
 //   wholewgt_HB_D_klb(iyear)=g2klb*wgtpar_a*pow(len_HB_D_mm(iyear),wgtpar_b);                
 // }
...
//    len_GR_mm(iyear,iage)=sum(elem_prod(lenprob_GR4(iage),lenbins));         
//    len_cH_D_mm(iyear,iage)=sum(elem_prod(lenprob_cH_D2(iage),lenbins)); 
...
//  //overwrite values for comm discards
//  for (iyear=(endyr_2008+1); iyear<=endyr; iyear++)
//  {
//    for (iage=1;iage<=nages; iage++)
//    {len_cH_D_mm(iyear,iage)=sum(elem_prod(lenprob_cH_D3(iage),lenbins)); }
//    wholewgt_cH_D_klb(iyear)=g2klb*wgtpar_a*pow(len_cH_D_mm(iyear),wgtpar_b);  
  }


//  //GR_D assumed same as HB_D
//  len_GR_D_mm=len_HB_D_mm;
//  wholewgt_GR_D_klb=wholewgt_HB_D_klb;                  
...
FUNCTION get_selectivity
	...
	//sel_FST_vec=logistic_double(agebins, selpar_A50_FST, selpar_slope_FST, selpar_A502_FST,selpar_slope2_FST);
	
  selpar_A50_cO2=selpar_A50_cH2; //setting all commercial other selectivity parameters to cH
  selpar_slope_cO2=selpar_slope_cH2;
  selpar_A502_cO2=selpar_A502_cH2;
  selpar_slope2_cO2=selpar_slope2_cH2;
  
  //sel_CVT_vec=logistic_double(agebins, selpar_A50_CVT, selpar_slope_CVT, selpar_A502_CVT,selpar_slope2_CVT);
  sel_CVT_vec=logistic_exponential(agebins, selpar_A50_CVT, selpar_slope_CVT, selpar_A502_CVT,selpar_slope2_CVT);
  //KCselpar_Age1_CVT=1.0/(1.0+mfexp(-selpar_Age1_CVT_logit));
  //KCselpar_Age2_CVT=1.0/(1.0+mfexp(-selpar_Age2_CVT_logit));
  //KCsel_CVT_vec(1)=selpar_Age1_CVT;
  //KC sel_CVT_vec(2)=selpar_Age2_CVT;
  
  sel_cH_block1=logistic(agebins, selpar_A50_cH1, selpar_slope_cH1);
  sel_cH_block2=logistic(agebins, selpar_A50_cH2, selpar_slope_cH2);
  //sel_cH_block1=logistic_double(agebins, selpar_A50_cH1, selpar_slope_cH1, selpar_A502_cH1, selpar_slope2_cH1);
  //sel_cH_block2=logistic_double(agebins, selpar_A50_cH2, selpar_slope_cH2, selpar_A502_cH2, selpar_slope2_cH2);
  //sel_cH_block1=sel_cH_block2;
  
  sel_cO_block2=logistic(agebins, selpar_A50_cO2, selpar_slope_cO2);
  ...
  sel_HB_block4=logistic(agebins, selpar_A50_HB4, selpar_slope_HB4);
  ...
  sel_GR_block4=logistic(agebins, selpar_A50_GR4, selpar_slope_GR4);
  
  //-------------Discard selectivities------------------------------
  selpar_Age2_HB_D3=1.0/(1.0+mfexp(-selpar_Age2_HB_D3_logit));
  selpar_Age2_HB_D4=1.0/(1.0+mfexp(-selpar_Age2_HB_D4_logit));
  
  selpar_Age2_cH_D2=1.0/(1.0+mfexp(-selpar_Age2_cH_D2_logit));
  
  sel_cH_D_2(1)=selpar_Age1_cH_D2;
  sel_cH_D_2(2)=selpar_Age2_cH_D2; 
  //cout << sel_cH_D_2 << endl;
  ...
  //sel_cH_D_3=logistic_double(agebins, selpar_A50_cH_D3, selpar_slope_cH_D3, selpar_A502_cH_D3, selpar_slope2_cH_D3);
  sel_cH_D_3=logistic_exponential(agebins, selpar_A50_cH_D3, selpar_slope_cH_D3, selpar_A502_cH_D3, selpar_slope2_cH_D3);
  sel_cH_D_3(1)=set_sel_cH_D_2(1);
  sel_cH_D_3(2)=set_sel_cH_D_2(2);
  //cout <<"sel_cH_D_2(2)"<< sel_cH_D_2(2)<<endl;
  //cout <<"sel_cH_D_3(2)"<< sel_cH_D_3(2)<<endl;
  ...
  if (iyear>endyr_selex_phase1 & iyear<=endyr_selex_phase2)
  
   {
	...
	sel_HB(iyear)=sel_HB_block2;
        sel_GR(iyear)=sel_HB_block2;
    //KC	sel_GR(iyear)=sel_GR_block2;
 	sel_cH_D(iyear)=sel_cH_D_2;
	//cout<<sel_cH_D<<endl;
    sel_HB_D(iyear)=sel_HB_D_2;
    sel_GR_D(iyear)=sel_HB_D_2;
  ...
  //Period 3 (commercial doesn't change from period 2)
   ...
   {   
    ...
    //KC sel_GR(iyear)=sel_GR_block3;
     sel_GR(iyear)=sel_HB_block3;  //KC
     
 	sel_cH_D(iyear)=sel_cH_D_2;     
    sel_HB_D(iyear)=sel_HB_D_3;
    sel_GR_D(iyear)=sel_HB_D_3;
   ...
   if (iyear>endyr_selex_phase3)
   {
         sel_cH(iyear)=sel_cH_block2; 
         sel_cO(iyear)=sel_cO_block2;    
         sel_HB(iyear)=sel_HB_block4;
         //KC sel_GR(iyear)=sel_GR_block4;
         sel_GR(iyear)=sel_HB_block4; //KC

		 //sel_D(iyear)=sel_D_block3;
         sel_HB_D(iyear)=sel_HB_D_4;
         sel_GR_D(iyear)=sel_HB_D_4;
         
         if (iyear<=endyr_2008){sel_cH_D(iyear)=sel_cH_D_2;} 
		//cout<<sel_cH_D_2<<endl;		 
         if (iyear>endyr_2008){sel_cH_D(iyear)=sel_cH_D_3;}
		//cout<<sel_cH_D<<endl;
                 sel_cH_D_3(1)=set_sel_cH_D_2(1);
                 sel_cH_D_3(2)=set_sel_cH_D_2(2);
	}
...
FUNCTION get_mortality
  ...
  log_F_dev_init_cHTR=log_F_dev_cHTR(styr_cHTR_L); 
  ...
  for (iyear=styr; iyear<=endyr; iyear++) 
  {
	...
	F_GR_D(iyear)=sel_HB_D(iyear)*F_GR_D_out(iyear); 
...
//Initialization
  ...
  //KC          sel_cO(styr)*mfexp(log_avg_F_cO+log_F_dev_init_cO)+
  //KC          sel_cHTR(styr)*mfexp(log_avg_F_cHTR+log_F_dev_init_cHTR)+
...
FUNCTION get_landings_wgt
  ...
  {    
    ...
    L_cHTR_klb(iyear)=elem_prod(L_cHTR_num(iyear),wholewgt_cHTR_klb(iyear));     //in 1000 lb whole weight
...
FUNCTION get_catchability_fcns    
 //Get rate increase if estimated, otherwise fixed above
  if (set_q_rate_phase>0.0)
  {
      ...
      for (iyear=styr_cH_cpue; iyear<=endyr_cH_cpue; iyear++)
      {   //KC if (iyear>styr_cH_cpue & iyear <=2003)
          {//q_rate_fcn_cH(iyear)=(1.0+q_rate)*q_rate_fcn_cH(iyear-1); //compound
             q_rate_fcn_cH(iyear)=(1.0+(iyear-styr_cH_cpue)*q_rate)*q_rate_fcn_cH(styr_cH_cpue);  //linear
          }
//KC          if (iyear>2003) {q_rate_fcn_cH(iyear)=q_rate_fcn_cH(iyear-1);} 
      }   
      for (iyear=styr_HB_cpue; iyear<=endyr_HB_cpue; iyear++)
      {   //KC if (iyear>styr_HB_cpue & iyear <=2003) 
          {//q_rate_fcn_HB(iyear)=(1.0+q_rate)*q_rate_fcn_HB(iyear-1); //compound
             q_rate_fcn_HB(iyear)=(1.0+(iyear-styr_HB_cpue)*q_rate)*q_rate_fcn_HB(styr_HB_cpue);  //linear
          }
//KC          if (iyear>2003) {q_rate_fcn_HB(iyear)=q_rate_fcn_HB(iyear-1);} 
      }   
       for (iyear=styr_GR_cpue; iyear<=endyr_GR_cpue; iyear++)
       {   //KC if (iyear>styr_GR_cpue & iyear <=2003) 
           {//q_rate_fcn_GR(iyear)=(1.0+q_rate)*q_rate_fcn_GR(iyear-1); //compound
              q_rate_fcn_GR(iyear)=(1.0+(iyear-styr_GR_cpue)*q_rate)*q_rate_fcn_GR(styr_GR_cpue);  //linear
           }
//KC           if (iyear>2003) {q_rate_fcn_GR(iyear)=q_rate_fcn_GR(iyear-1);} 
       }   
...
//---Predicted CPUEs------------------------
 ...
 //GR cpue 
  // sel_GR_cpue.initialize(); //approximate selectivity; includes discards (live + dead)
   ...
   {   
      ...
      N_GR(iyear)=elem_prod(N_mdyr(iyear),sel_GR(iyear)); 
 ...
 //MARMAP Snapper trap cpue
  q_FST(styr_FST_cpue)=mfexp(log_q_FST); 
  for (iyear=styr_FST_cpue; iyear<=endyr_FST_cpue; iyear++)
  {   
    N_FST(iyear)=elem_prod(N_mdyr(iyear),sel_FST(iyear)); 
	pred_FST_cpue(iyear)=q_FST(iyear)*q_DD_fcn(iyear)*sum(N_FST(iyear));
    if (iyear<endyr_FST_cpue){q_FST(iyear+1)=q_FST(iyear)*mfexp(q_RW_log_dev_FST(iyear));}
  }
...
//  for (iyear=1;iyear<=nyr_FST_lenc;iyear++)
//    {pred_FST_lenc(iyear)=(N_FST(yrs_FST_lenc(iyear))*lenprob_FST)/sum(N_FST(yrs_FST_lenc(iyear)));}
  
// //Commercial
//   //lines
//  for (iyear=1;iyear<=nyr_cH_lenc;iyear++)
//   
//   {if (yrs_cH_lenc(iyear)<=endyr_selex_phase1)
//		{pred_cH_lenc(iyear)=(L_cH_num(yrs_cH_lenc(iyear))*lenprob_cH1)/sum(L_cH_num(yrs_cH_lenc(iyear)));}
	
//	if (yrs_cH_lenc(iyear)>endyr_selex_phase1)
//		{pred_cH_lenc(iyear)=(L_cH_num(yrs_cH_lenc(iyear))*lenprob_cH2)/sum(L_cH_num(yrs_cH_lenc(iyear)));}
//	}
//  //Other 
//  for (iyear=1;iyear<=nyr_cO_lenc;iyear++)
//  {
//     if (yrs_cO_lenc(iyear)<=endyr_selex_phase1)
//     {pred_cO_lenc(iyear)=(L_cO_num(yrs_cO_lenc(iyear))*lenprob_cO1)/sum(L_cO_num(yrs_cO_lenc(iyear)));}
     
//	 else
//     {pred_cO_lenc(iyear)=(L_cO_num(yrs_cO_lenc(iyear))*lenprob_cO2)/sum(L_cO_num(yrs_cO_lenc(iyear))); }      
//  }
//  //Discards 
// for (iyear=1;iyear<=nyr_cH_D_lenc;iyear++)
// {
//    if (yrs_cH_D_lenc(iyear)<=endyr_2008)
//    {pred_cH_D_lenc(iyear)=(D_cH_num(yrs_cH_D_lenc(iyear))*lenprob_cH_D2)
//                            /sum(D_cH_num(yrs_cH_D_lenc(iyear)));}
//    else
//    {pred_cH_D_lenc(iyear)=(D_cH_num(yrs_cH_D_lenc(iyear))*lenprob_cH_D3)
//                            /sum(D_cH_num(yrs_cH_D_lenc(iyear)));}
// }

//Headboat
// for (iyear=1;iyear<=nyr_HB_lenc;iyear++)
// {	if (yrs_HB_lenc(iyear)<=endyr_selex_phase1)
//		{pred_HB_lenc(iyear)=(L_HB_num(yrs_HB_lenc(iyear))*lenprob_HB1)/sum(L_HB_num(yrs_HB_lenc(iyear)));}
//   if (yrs_HB_lenc(iyear)>endyr_selex_phase1 &    		
//	yrs_HB_lenc(iyear)<=endyr_selex_phase2)
//		{pred_HB_lenc(iyear)=(L_HB_num(yrs_HB_lenc(iyear))*lenprob_HB2)/sum(L_HB_num(yrs_HB_lenc(iyear)));}
//	if (yrs_HB_lenc(iyear)>endyr_selex_phase2 &  
//	yrs_HB_lenc(iyear)<=endyr_selex_phase3)
//		{pred_HB_lenc(iyear)=(L_HB_num(yrs_HB_lenc(iyear))*lenprob_HB3)/sum(L_HB_num(yrs_HB_lenc(iyear)));}
//	if (yrs_HB_lenc(iyear)>endyr_selex_phase3) 
//		{pred_HB_lenc(iyear)=(L_HB_num(yrs_HB_lenc(iyear))*lenprob_HB4)/sum(L_HB_num(yrs_HB_lenc(iyear)));}  
//  }   
	//Discards
//  for (iyear=1;iyear<=nyr_HB_D_lenc;iyear++)
//  { 
//	if (yrs_HB_D_lenc(iyear)<=endyr_selex_phase3) 			{pred_HB_D_lenc(iyear)=(D_HB_num(yrs_HB_D_lenc(iyear))*lenprob_HB_D3)/sum(D_HB_num(yrs_HB_D_lenc(iyear)));}
    
//	else    		{pred_HB_D_lenc(iyear)=(D_HB_num(yrs_HB_D_lenc(iyear))*lenprob_HB_D4)/sum(D_HB_num(yrs_HB_D_lenc(iyear)));}
//   }
 
//GR
// for (iyear=1;iyear<=nyr_GR_lenc;iyear++)
//  { if (yrs_GR_lenc(iyear)<=endyr_selex_phase1) 
//		{pred_GR_lenc(iyear)=(L_GR_num(yrs_GR_lenc(iyear))*lenprob_GR1)/sum(L_GR_num(yrs_GR_lenc(iyear)));}
	
//	if (yrs_GR_lenc(iyear)>endyr_selex_phase1 &
//	yrs_GR_lenc(iyear)<=endyr_selex_phase2)
//		{pred_GR_lenc(iyear)=(L_GR_num(yrs_GR_lenc(iyear))*lenprob_GR2)/sum(L_GR_num(yrs_GR_lenc(iyear)));}
 
//    if (yrs_GR_lenc(iyear)>endyr_selex_phase2 & 
//	yrs_GR_lenc(iyear)<=endyr_selex_phase3)
//		{pred_GR_lenc(iyear)=(L_GR_num(yrs_GR_lenc(iyear))*lenprob_GR3)/sum(L_GR_num(yrs_GR_lenc(iyear)));}

//    if (yrs_GR_lenc(iyear)>endyr_selex_phase3)
//		{pred_GR_lenc(iyear)=(L_GR_num(yrs_GR_lenc(iyear))*lenprob_GR4)/sum(L_GR_num(yrs_GR_lenc(iyear)));}
// }
...
FUNCTION get_weighted_current //should not and does not include historic trawl
  ...
  //F_temp_sum+=mfexp((selpar_n_yrs_wgted*log_avg_F_cHTR+
  //      sum(log_F_dev_cHTR((endyr-selpar_n_yrs_wgted+1),endyr)))/selpar_n_yrs_wgted);
  ...
  //F_cHTR_prop=mfexp((selpar_n_yrs_wgted*log_avg_F_cHTR+
  //      //sum(log_F_dev_cHTR((endyr-selpar_n_yrs_wgted+1),endyr)))/selpar_n_yrs_wgted)/F_te//mp_sum;
  ...
  //log_F_dev_end_cHTR=sum(log_F_dev_cHTR((endyr-selpar_n_yrs_wgted+1),endyr))/selpar_n_yrs_wgted;
  ...
  F_end_L=sel_cH(endyr)*mfexp(log_avg_F_cH+log_F_dev_end_cH)+
          ...
          //sel_cHTR(endyr)*mfexp(log_avg_F_cHTR+log_F_dev_end_cHTR)+
 ...
 //cout << F_end_L << endl;
  ...
  F_end_D=sel_cH_D(endyr)*mfexp(log_avg_F_cH_D+log_F_dev_end_cH_D)+
          ...
          sel_HB_D(endyr)*mfexp(log_avg_F_GR_D+log_F_dev_end_GR_D);   
...
//switch here if var_rec_dev <=dzero 
  ...
  for(iyear=styr; iyear<=endyr; iyear++)
  {
        L_total_klb_yr(iyear)=pred_cH_L_klb(iyear)+pred_cO_L_klb(iyear)+pred_cHTR_L_klb(iyear)+pred_HB_L_klb(iyear)+pred_GR_L_klb(iyear);
        L_total_knum_yr(iyear)=pred_cH_L_knum(iyear)+pred_cO_L_knum(iyear)+pred_cHTR_L_knum(iyear)+pred_HB_L_knum(iyear)+pred_GR_L_knum(iyear);
  ...
  L_total_num=L_cH_num+L_cO_num+L_HB_num+L_cHTR_num+L_GR_num;   //landings at age in number fish
  L_total_klb=L_cH_klb+L_cO_klb+L_cHTR_klb+L_HB_klb+L_GR_klb;   //landings at age in klb whole weight
...
//---Indices-------------------------------
  ...
  f_FST_cpue=0.0;
  f_FST_cpue=lk_lognormal(pred_FST_cpue, obs_FST_cpue, FST_cpue_cv, w_I_FST);
  fval+=f_FST_cpue;
  fval_data+=f_FST_cpue;
...
//---Landings-------------------------------
  ...
  f_cHTR_L=lk_lognormal(pred_cHTR_L_klb(styr_cHTR_L,endyr_cHTR_L), obs_cHTR_L(styr_cHTR_L,endyr_cHTR_L),
                      cHTR_L_cv(styr_cHTR_L,endyr_cHTR_L), w_L);
...
//---Length comps-------------------------------
  ...
  //KC f_cH_lenc=lk_robust_multinomial(nsamp_cH_lenc, pred_cH_lenc, obs_cH_lenc, nyr_cH_lenc, double(nlenbins), minSS_cH_lenc, w_lc_cH);
  ...
  //f_cO_lenc
  f_cO_lenc=lk_multinomial(nsamp_cO_lenc, pred_cO_lenc, obs_cO_lenc, nyr_cO_lenc, minSS_cO_lenc, w_lc_cO);
  //KC f_cO_lenc=lk_robust_multinomial(nsamp_cO_lenc, pred_cO_lenc, obs_cO_lenc, nyr_cO_lenc, double(nlenbins), minSS_cO_lenc, w_lc_cO);
  ...
  ////KC f_HB_lenc=lk_robust_multinomial(nsamp_HB_lenc, pred_HB_lenc, obs_HB_lenc, nyr_HB_lenc, double(nlenbins), minSS_HB_lenc, w_lc_HB);
 ...
 // //KC f_GR_lenc=lk_robust_multinomial(nsamp_GR_lenc, pred_GR_lenc, obs_GR_lenc, nyr_GR_lenc, double(nlenbins), minSS_GR_lenc, w_lc_GR);
 ...
 // fval_data+=f_GR_lenc;
  ...
  //KC f_HB_D_lenc=lk_robust_multinomial(nsamp_HB_D_lenc, pred_HB_D_lenc, obs_HB_D_lenc, nyr_HB_D_lenc, double(nlenbins), minSS_HB_D_lenc, w_lc_HB_D);
  ...
  //f_cH_D_lenc
  //f_cH_D_lenc=lk_multinomial(nsamp_cH_D_lenc, pred_cH_D_lenc, obs_cH_D_lenc, nyr_cH_D_lenc, minSS_cH_D_lenc, w_lc_cH_D);
  //KC f_cH_D_lenc=lk_robust_multinomial(nsamp_cH_D_lenc, pred_cH_D_lenc, obs_cH_D_lenc, nyr_cH_D_lenc, double(nlenbins), minSS_cH_D_lenc, w_lc_cH_D);
  ...
  //f_FST_lenc
  f_FST_lenc=lk_multinomial(nsamp_FST_lenc, pred_FST_lenc, obs_FST_lenc, nyr_FST_lenc, minSS_FST_lenc, w_lc_FST);
  //KC f_FST_lenc=lk_robust_multinomial(nsamp_FST_lenc, pred_FST_lenc, obs_FST_lenc, nyr_FST_lenc, double(nlenbins), minSS_FST_lenc, w_lc_FST);
  //f_FST_lenc=lk_logistic_normal(nsamp_FST_lenc, pred_FST_lenc, obs_FST_lenc, nyr_FST_lenc, double(nlenbins), minSS_FST_lenc);
  //f_FST_lenc=lk_dirichlet_multinomial(nsamp_FST_lenc, pred_FST_lenc, obs_FST_lenc, nyr_FST_lenc, double(nlenbins), minSS_FST_lenc, log_dm_FST_lc);
  fval+=f_FST_lenc;
  fval_data+=f_FST_lenc;
...
//---Age comps-------------------------------
  ...
  //KC f_cH_agec=lk_robust_multinomial(nsamp_cH_agec, pred_cH_agec, obs_cH_agec, nyr_cH_agec, double(nages_agec), minSS_cH_agec, w_ac_cH);
  ...
  //KC f_HB_agec=lk_robust_multinomial(nsamp_HB_agec, pred_HB_agec, obs_HB_agec, nyr_HB_agec, double(nages_agec), minSS_HB_agec, w_ac_HB);
  ...
  //KC f_GR_agec=lk_robust_multinomial(nsamp_GR_agec, pred_GR_agec, obs_GR_agec, nyr_GR_agec, double(nages_agec), minSS_GR_agec, w_ac_GR);
  ...
  //f_CVT_agec
  //f_CVT_agec=lk_multinomial(nsamp_CVT_agec, pred_CVT_agec, obs_CVT_agec, nyr_CVT_agec, minSS_CVT_agec, w_ac_CVT);
  //KC f_CVT_agec=lk_robust_multinomial(nsamp_CVT_agec, pred_CVT_agec, obs_CVT_agec, nyr_CVT_agec, double(nages_agec), minSS_CVT_agec, w_ac_CVT);
...
//kc added below
 f_GR_RWq_cpue=0.0;
 for (iyear=styr_GR_cpue; iyear<endyr_GR_cpue; iyear++)
     {f_GR_RWq_cpue+=square(q_RW_log_dev_GR(iyear))/(2.0*set_RWq_var);}
 fval+=f_GR_RWq_cpue; 
...
//pdf type 1=none, 2=lognormal, 3=normal, 4=beta 
  ...
  f_priors+=neg_log_prior(selpar_A50_cO1,set_selpar_A50_cO1(5), set_selpar_A50_cO1(6), set_selpar_A50_cO1(7));
  f_priors+=neg_log_prior(selpar_slope_cO1,set_selpar_slope_cO1(5), set_selpar_slope_cO1(6), set_selpar_slope_cO1(7));
  f_priors+=neg_log_prior(selpar_A502_cO1,set_selpar_A502_cO1(5), set_selpar_A502_cO1(6), set_selpar_A502_cO1(7));
  f_priors+=neg_log_prior(selpar_slope2_cO1,set_selpar_slope2_cO1(5), set_selpar_slope2_cO1(6), set_selpar_slope2_cO1(7));
  ...
  f_priors+=neg_log_prior(selpar_A502_HB4,set_selpar_A502_HB4(5), set_selpar_A502_HB4(6), set_selpar_A502_HB4(7));
  f_priors+=neg_log_prior(selpar_slope2_HB4,set_selpar_slope2_HB4(5), set_selpar_slope2_HB4(6), set_selpar_slope2_HB4(7));
  ...
  f_priors+=neg_log_prior(selpar_A502_GR3,set_selpar_A502_GR3(5), set_selpar_A502_GR3(6), set_selpar_A502_GR3(7));
  f_priors+=neg_log_prior(selpar_slope2_GR3,set_selpar_slope2_GR3(5), set_selpar_slope2_GR3(6), set_selpar_slope2_GR3(7));
  f_priors+=neg_log_prior(selpar_A50_GR4,set_selpar_A50_GR4(5), set_selpar_A50_GR4(6), set_selpar_A50_GR4(7));
  f_priors+=neg_log_prior(selpar_slope_GR4,set_selpar_slope_GR4(5), set_selpar_slope_GR4(6), set_selpar_slope_GR4(7));
  f_priors+=neg_log_prior(selpar_A502_GR4,set_selpar_A502_GR4(5), set_selpar_A502_GR4(6), set_selpar_A502_GR4(7));
  f_priors+=neg_log_prior(selpar_slope2_GR4,set_selpar_slope2_GR4(5), set_selpar_slope2_GR4(6), set_selpar_slope2_GR4(7));
  ...
  //f_priors+=neg_log_prior(selpar_Age1_CVT_logit, set_selpar_Age1_CVT_logit(5),set_selpar_Age1_CVT_logit(6), set_selpar_Age1_CVT_logit(7));    
  //f_priors+=neg_log_prior(selpar_Age2_CVT_logit, set_selpar_Age2_CVT_logit(5),set_selpar_Age2_CVT_logit(6),set_selpar_Age2_CVT_logit(7)); 

  f_priors+=neg_log_prior(selpar_Age2_cH_D2_logit, set_selpar_Age2_cH_D2_logit(5),set_selpar_Age2_cH_D2_logit(6),set_selpar_Age2_cH_D2_logit(7));
  f_priors+=neg_log_prior(selpar_A502_cH_D3, set_selpar_A502_cH_D3(5),set_selpar_A502_cH_D3(6),set_selpar_A502_cH_D3(7));

  f_priors+=neg_log_prior(selpar_Age2_HB_D3_logit, set_selpar_Age2_HB_D3_logit(5),set_selpar_Age2_HB_D3_logit(6),set_selpar_Age2_HB_D3_logit(7));
  f_priors+=neg_log_prior(selpar_Age2_HB_D4_logit, set_selpar_Age2_HB_D4_logit(5),set_selpar_Age2_HB_D4_logit(6),set_selpar_Age2_HB_D4_logit(7));
  ...
  f_priors+=neg_log_prior(log_q_FST,set_log_q_FST(5),set_log_q_FST(6),set_log_q_FST(7));
  ...
  //f_priors+=neg_log_prior(log_dm_FST_lc,set_log_dm_FST_lc(5),set_log_dm_FST_lc(6),set_log_dm_FST_lc(7));
...
REPORT_SECTION
 ...
 //      cout<<"xdum = "<<xdum<<endl;
      ...
      //sdnr_lc_FST=sdnr_multinomial(nyr_FST_lenc, lenbins, nsamp_FST_lenc, pred_FST_lenc, obs_FST_lenc, w_lc_FST);	  
      ...
      sdnr_I_FST=sdnr_lognormal(pred_FST_cpue, obs_FST_cpue, FST_cpue_cv, w_I_FST);
      ...
      //################################################################################################# 
       ...
       log_dm_cH_D_lc_out(8)=log_dm_cH_D_lc; log_dm_cH_D_lc_out(1,7)=set_log_dm_cH_D_lc;   //kc check this? was HB_D (repeated)
       //log_dm_FST_lc_out(8)=log_dm_FST_lc; log_dm_FST_lc_out(1,7)=set_log_dm_FST_lc;
	   ...
	   selpar_A50_cO1_out(8)=selpar_A50_cO1; selpar_A50_cO1_out(1,7)=set_selpar_A50_cO1;
       selpar_slope_cO1_out(8)=selpar_slope_cO1; selpar_slope_cO1_out(1,7)=set_selpar_slope_cO1;
       selpar_A502_cO1_out(8)=selpar_A502_cO1; selpar_A502_cO1_out(1,7)=set_selpar_A502_cO1;
       selpar_slope2_cO1_out(8)=selpar_slope2_cO1; selpar_slope2_cO1_out(1,7)=set_selpar_slope2_cO1;	  
	   ...
	   selpar_A502_HB4_out(8)=selpar_A502_HB4; selpar_A502_HB4_out(1,7)=set_selpar_A502_HB4;
       selpar_slope2_HB4_out(8)=selpar_slope2_HB4; selpar_slope2_HB4_out(1,7)=set_selpar_slope2_HB4;
	   ...
	   selpar_A50_GR4_out(8)=selpar_A50_GR4; selpar_A50_GR4_out(1,7)=set_selpar_A50_GR4;
       selpar_slope_GR4_out(8)=selpar_slope_GR4; selpar_slope_GR4_out(1,7)=set_selpar_slope_GR4;
	   selpar_A502_GR4_out(8)=selpar_A502_GR4; selpar_A502_GR4_out(1,7)=set_selpar_A502_GR4;
       selpar_slope2_GR4_out(8)=selpar_slope2_GR4; selpar_slope2_GR4_out(1,7)=set_selpar_slope2_GR4;
	   ...
	   //selpar_Age1_CVT_logit_out(8)=selpar_Age1_CVT_logit; selpar_Age1_CVT_logit_out(1,7)=set_selpar_Age1_CVT_logit;
	   //KC  selpar_Age2_CVT_logit_out(8)=selpar_Age2_CVT_logit; selpar_Age2_CVT_logit_out(1,7)=set_selpar_Age2_CVT_logit;
       ...
       log_q_FST_out(8)=log_q_FST; log_q_FST_out(1,7)=set_log_q_FST;
       ...
       log_avg_F_cHTR_out(8)=log_avg_F_cHTR; log_avg_F_cHTR_out(1,7)=set_log_avg_F_cHTR;
       ...
       log_F_dev_cHTR_out(styr_cHTR_L,endyr_cHTR_L)=log_F_dev_cHTR;
   ...
   #include "vs_make_Robject.cxx"   // write the R-compatible report
